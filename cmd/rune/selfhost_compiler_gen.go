...
type CompilerModuleMacroBinding struct {
	module  string
...
var selfhost_compiler_dom_types_DOM_EVENT_NAMES []string = []string{"abort", "animationcancel", "animationend", "animationiteration", "animationstart", "auxclick", "beforeinput", "beforematch", "beforetoggle", "blur", "cancel", "canplay", "canplaythrough", "change", "click", "close", "command", "compositionend", "compositionstart", "compositionupdate", "contextlost", "contextmenu", "contextrestored", "copy", "cuechange", "cut", "dblclick", "drag", "dragend", "dragenter", "dragleave", "dragover", "dragstart", "drop", "durationchange", "emptied", "ended", "error", "focus", "focusin", "focusout", "formdata", "fullscreenchange", "fullscreenerror", "gotpointercapture", "input", "invalid", "keydown", "keypress", "keyup", "load", "loadeddata", "loadedmetadata", "loadstart", "lostpointercapture", "mousedown", "mouseenter", "mouseleave", "mousemove", "mouseout", "mouseover", "mouseup", "paste", "pause", "play", "playing", "pointercancel", "pointerdown", "pointerenter", "pointerleave", "pointermove", "pointerout", "pointerover", "pointerrawupdate", "pointerup", "progress", "ratechange", "reset", "resize", "scroll", "scrollend", "securitypolicyviolation", "seeked", "seeking", "select", "selectionchange", "selectstart", "slotchange", "stalled", "submit", "suspend", "timeupdate", "toggle", "touchcancel", "touchend", "touchmove", "touchstart", "transitioncancel", "transitionend", "transitionrun", "transitionstart", "volumechange", "waiting", "webkitanimationend", "webkitanimationiteration", "webkitanimationstart", "webkittransitionend", "wheel"}

var selfhost_compiler_dom_types_DOM_EVENT_TYPE_NAMES []string = []string{"UIEvent", "AnimationEvent", "AnimationEvent", "AnimationEvent", "AnimationEvent", "PointerEvent", "InputEvent", "Event", "ToggleEvent", "FocusEvent", "Event", "Event", "Event", "Event", "PointerEvent", "Event", "Event", "CompositionEvent", "CompositionEvent", "CompositionEvent", "Event", "PointerEvent", "Event", "ClipboardEvent", "Event", "ClipboardEvent", "MouseEvent", "DragEvent", "DragEvent", "DragEvent", "DragEvent", "DragEvent", "DragEvent", "DragEvent", "Event", "Event", "Event", "ErrorEvent", "FocusEvent", "FocusEvent", "FocusEvent", "FormDataEvent", "Event", "Event", "PointerEvent", "InputEvent", "Event", "KeyboardEvent", "KeyboardEvent", "KeyboardEvent", "Event", "Event", "Event", "Event", "PointerEvent", "MouseEvent", "MouseEvent", "MouseEvent", "MouseEvent", "MouseEvent", "MouseEvent", "MouseEvent", "ClipboardEvent", "Event", "Event", "Event", "PointerEvent", "PointerEvent", "PointerEvent", "PointerEvent", "PointerEvent", "PointerEvent", "PointerEvent", "Event", "PointerEvent", "ProgressEvent", "Event", "Event", "UIEvent", "Event", "Event", "SecurityPolicyViolationEvent", "Event", "Event", "Event", "Event", "Event", "Event", "Event", "SubmitEvent", "Event", "Event", "ToggleEvent", "TouchEvent", "TouchEvent", "TouchEvent", "TouchEvent", "TransitionEvent", "TransitionEvent", "TransitionEvent", "TransitionEvent", "Event", "Event", "Event", "Event", "Event", "Event", "WheelEvent"}

var selfhost_compiler_dom_types_DOM_TAG_NAMES []string = []string{"a", "abbr", "address", "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "data", "datalist", "dd", "del", "details", "dfn", "dialog", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "iframe", "img", "input", "ins", "kbd", "label", "legend", "li", "link", "main", "map", "mark", "menu", "meta", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "script", "search", "section", "select", "slot", "small", "source", "span", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "u", "ul", "var", "video", "wbr"}

var selfhost_compiler_dom_types_DOM_TAG_ELEMENT_TYPES []string = []string{"HTMLAnchorElement", "HTMLElement", "HTMLElement", "HTMLAreaElement", "HTMLElement", "HTMLElement", "HTMLAudioElement", "HTMLElement", "HTMLBaseElement", "HTMLElement", "HTMLElement", "HTMLQuoteElement", "HTMLBodyElement", "HTMLBRElement", "HTMLButtonElement", "HTMLCanvasElement", "HTMLTableCaptionElement", "HTMLElement", "HTMLElement", "HTMLTableColElement", "HTMLTableColElement", "HTMLDataElement", "HTMLDataListElement", "HTMLElement", "HTMLModElement", "HTMLDetailsElement", "HTMLElement", "HTMLDialogElement", "HTMLDivElement", "HTMLDListElement", "HTMLElement", "HTMLElement", "HTMLEmbedElement", "HTMLFieldSetElement", "HTMLElement", "HTMLElement", "HTMLElement", "HTMLFormElement", "HTMLHeadingElement", "HTMLHeadingElement", "HTMLHeadingElement", "HTMLHeadingElement", "HTMLHeadingElement", "HTMLHeadingElement", "HTMLHeadElement", "HTMLElement", "HTMLElement", "HTMLHRElement", "HTMLHtmlElement", "HTMLElement", "HTMLIFrameElement", "HTMLImageElement", "HTMLInputElement", "HTMLModElement", "HTMLElement", "HTMLLabelElement", "HTMLLegendElement", "HTMLLIElement", "HTMLLinkElement", "HTMLElement", "HTMLMapElement", "HTMLElement", "HTMLMenuElement", "HTMLMetaElement", "HTMLMeterElement", "HTMLElement", "HTMLElement", "HTMLObjectElement", "HTMLOListElement", "HTMLOptGroupElement", "HTMLOptionElement", "HTMLOutputElement", "HTMLParagraphElement", "HTMLPictureElement", "HTMLPreElement", "HTMLProgressElement", "HTMLQuoteElement", "HTMLElement", "HTMLElement", "HTMLElement", "HTMLElement", "HTMLElement", "HTMLScriptElement", "HTMLElement", "HTMLElement", "HTMLSelectElement", "HTMLSlotElement", "HTMLElement", "HTMLSourceElement", "HTMLSpanElement", "HTMLElement", "HTMLStyleElement", "HTMLElement", "HTMLElement", "HTMLElement", "HTMLTableElement", "HTMLTableSectionElement", "HTMLTableCellElement", "HTMLTemplateElement", "HTMLTextAreaElement", "HTMLTableSectionElement", "HTMLTableCellElement", "HTMLTableSectionElement", "HTMLTimeElement", "HTMLTitleElement", "HTMLTableRowElement", "HTMLTrackElement", "HTMLElement", "HTMLUListElement", "HTMLElement", "HTMLVideoElement", "HTMLElement"}

var selfhost_compiler_dom_types_DOM_STRUCT_NAMES []string = []string{"AnimationEvent", "ClipboardEvent", "CompositionEvent", "DragEvent", "ErrorEvent", "Event", "EventTarget", "FocusEvent", "FormDataEvent", "HTMLButtonElement", "HTMLInputElement", "HTMLOptionElement", "HTMLSelectElement", "HTMLTextAreaElement", "InputEvent", "KeyboardEvent", "MouseEvent", "Node", "PointerEvent", "ProgressEvent", "SecurityPolicyViolationEvent", "SubmitEvent", "ToggleEvent", "TouchEvent", "TransitionEvent", "UIEvent", "WheelEvent"}

var selfhost_compiler_dom_types_DOM_STRUCT_MEMBERS [][]string = [][]string{[]string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "animationName:String", "elapsedTime:Dynamic", "pseudoElement:String"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "clipboardData:DataTransfer"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "data:String", "initCompositionEvent(String, Bool, Bool, WindowProxy, String): Dynamic"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "button:Dynamic", "buttons:Dynamic", "clientX:Dynamic", "clientY:Dynamic", "ctrlKey:Bool", "layerX:Dynamic", "layerY:Dynamic", "metaKey:Bool", "movementX:Dynamic", "movementY:Dynamic", "offsetX:Dynamic", "offsetY:Dynamic", "pageX:Dynamic", "pageY:Dynamic", "relatedTarget:EventTarget", "screenX:Dynamic", "screenY:Dynamic", "shiftKey:Bool", "x:Dynamic", "y:Dynamic", "getModifierState(String): Bool", "initMouseEvent(String, Bool, Bool, Window, Dynamic, Dynamic, Dynamic, Dynamic, Dynamic, Bool, Bool, Bool, Bool, Dynamic, EventTarget): Dynamic", "dataTransfer:DataTransfer"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "colno:Dynamic", "error:Dynamic", "filename:String", "lineno:Dynamic", "message:String"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "relatedTarget:EventTarget"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "formData:FormData"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20", "ariaActiveDescendantElement:Element", "ariaAtomic:String", "ariaAutoComplete:String", "ariaBrailleLabel:String", "ariaBrailleRoleDescription:String", "ariaBusy:String", "ariaChecked:String", "ariaColCount:String", "ariaColIndex:String", "ariaColIndexText:String", "ariaColSpan:String", "ariaControlsElements:Array[Element]", "ariaCurrent:String", "ariaDescribedByElements:Array[Element]", "ariaDescription:String", "ariaDetailsElements:Array[Element]", "ariaDisabled:String", "ariaErrorMessageElements:Array[Element]", "ariaExpanded:String", "ariaFlowToElements:Array[Element]", "ariaHasPopup:String", "ariaHidden:String", "ariaInvalid:String", "ariaKeyShortcuts:String", "ariaLabel:String", "ariaLabelledByElements:Array[Element]", "ariaLevel:String", "ariaLive:String", "ariaModal:String", "ariaMultiLine:String", "ariaMultiSelectable:String", "ariaOrientation:String", "ariaOwnsElements:Array[Element]", "ariaPlaceholder:String", "ariaPosInSet:String", "ariaPressed:String", "ariaReadOnly:String", "ariaRelevant:String", "ariaRequired:String", "ariaRoleDescription:String", "ariaRowCount:String", "ariaRowIndex:String", "ariaRowIndexText:String", "ariaRowSpan:String", "ariaSelected:String", "ariaSetSize:String", "ariaSort:String", "ariaValueMax:String", "ariaValueMin:String", "ariaValueNow:String", "ariaValueText:String", "role:String", "animate(Dynamic, Dynamic): Animation", "getAnimations(GetAnimationsOptions): Array[Animation]", "after(Dynamic): Dynamic", "before(Dynamic): Dynamic", "remove(): Dynamic", "replaceWith(Dynamic): Dynamic", "nextElementSibling:Element", "previousElementSibling:Element", "childElementCount:Dynamic", "children:HTMLCollection", "firstElementChild:Element", "lastElementChild:Element", "append(Dynamic): Dynamic", "moveBefore(Node, Node): Dynamic", "prepend(Dynamic): Dynamic", "querySelector(K): Dynamic", "querySelectorAll(K): NodeListOf", "replaceChildren(Dynamic): Dynamic", "assignedSlot:HTMLSlotElement", "attributes:NamedNodeMap", "classList:DOMTokenList", "className:String", "clientHeight:Dynamic", "clientLeft:Dynamic", "clientTop:Dynamic", "clientWidth:Dynamic", "currentCSSZoom:Dynamic", "customElementRegistry:CustomElementRegistry", "id:String", "innerHTML:String", "localName:String", "namespaceURI:String", "onfullscreenchange:Dynamic", "onfullscreenerror:Dynamic", "outerHTML:String", "part:DOMTokenList", "prefix:String", "scrollHeight:Dynamic", "scrollLeft:Dynamic", "scrollTop:Dynamic", "scrollWidth:Dynamic", "shadowRoot:ShadowRoot", "slot:String", "tagName:String", "attachShadow(ShadowRootInit): ShadowRoot", "checkVisibility(CheckVisibilityOptions): Bool", "closest(K): Dynamic", "computedStyleMap(): StylePropertyMapReadOnly", "getAttribute(String): String", "getAttributeNS(String, String): String", "getAttributeNames(): Array[String]", "getAttributeNode(String): Attr", "getAttributeNodeNS(String, String): Attr", "getBoundingClientRect(): DOMRect", "getClientRects(): DOMRectList", "getElementsByClassName(String): HTMLCollectionOf", "getElementsByTagName(K): HTMLCollectionOf", "getElementsByTagNameNS(String): HTMLCollectionOf", "getHTML(GetHTMLOptions): String", "hasAttribute(String): Bool", "hasAttributeNS(String, String): Bool", "hasAttributes(): Bool", "hasPointerCapture(Dynamic): Bool", "insertAdjacentElement(InsertPosition, Element): Element", "insertAdjacentHTML(InsertPosition, String): Dynamic", "insertAdjacentText(InsertPosition, String): Dynamic", "matches(K): Dynamic", "releasePointerCapture(Dynamic): Dynamic", "removeAttribute(String): Dynamic", "removeAttributeNS(String, String): Dynamic", "removeAttributeNode(Attr): Attr", "requestFullscreen(FullscreenOptions): Promise", "requestPointerLock(PointerLockOptions): Promise", "scroll(ScrollToOptions): Dynamic", "scrollBy(ScrollToOptions): Dynamic", "scrollIntoView(Dynamic): Dynamic", "scrollTo(ScrollToOptions): Dynamic", "setAttribute(String, String): Dynamic", "setAttributeNS(String, String, String): Dynamic", "setAttributeNode(Attr): Attr", "setAttributeNodeNS(Attr): Attr", "setHTMLUnsafe(String): Dynamic", "setPointerCapture(Dynamic): Dynamic", "toggleAttribute(String, Bool): Bool", "webkitMatchesSelector(String): Bool", "attributeStyleMap:StylePropertyMap", "style:CSSStyleDeclaration", "contentEditable:String", "enterKeyHint:String", "inputMode:String", "isContentEditable:Bool", "onabort:Dynamic", "onanimationcancel:Dynamic", "onanimationend:Dynamic", "onanimationiteration:Dynamic", "onanimationstart:Dynamic", "onauxclick:Dynamic", "onbeforeinput:Dynamic", "onbeforematch:Dynamic", "onbeforetoggle:Dynamic", "onblur:Dynamic", "oncancel:Dynamic", "oncanplay:Dynamic", "oncanplaythrough:Dynamic", "onchange:Dynamic", "onclick:Dynamic", "onclose:Dynamic", "oncommand:Dynamic", "oncontextlost:Dynamic", "oncontextmenu:Dynamic", "oncontextrestored:Dynamic", "oncopy:Dynamic", "oncuechange:Dynamic", "oncut:Dynamic", "ondblclick:Dynamic", "ondrag:Dynamic", "ondragend:Dynamic", "ondragenter:Dynamic", "ondragleave:Dynamic", "ondragover:Dynamic", "ondragstart:Dynamic", "ondrop:Dynamic", "ondurationchange:Dynamic", "onemptied:Dynamic", "onended:Dynamic", "onerror:OnErrorEventHandler", "onfocus:Dynamic", "onformdata:Dynamic", "ongotpointercapture:Dynamic", "oninput:Dynamic", "oninvalid:Dynamic", "onkeydown:Dynamic", "onkeypress:Dynamic", "onkeyup:Dynamic", "onload:Dynamic", "onloadeddata:Dynamic", "onloadedmetadata:Dynamic", "onloadstart:Dynamic", "onlostpointercapture:Dynamic", "onmousedown:Dynamic", "onmouseenter:Dynamic", "onmouseleave:Dynamic", "onmousemove:Dynamic", "onmouseout:Dynamic", "onmouseover:Dynamic", "onmouseup:Dynamic", "onpaste:Dynamic", "onpause:Dynamic", "onplay:Dynamic", "onplaying:Dynamic", "onpointercancel:Dynamic", "onpointerdown:Dynamic", "onpointerenter:Dynamic", "onpointerleave:Dynamic", "onpointermove:Dynamic", "onpointerout:Dynamic", "onpointerover:Dynamic", "onpointerrawupdate:Dynamic", "onpointerup:Dynamic", "onprogress:Dynamic", "onratechange:Dynamic", "onreset:Dynamic", "onresize:Dynamic", "onscroll:Dynamic", "onscrollend:Dynamic", "onsecuritypolicyviolation:Dynamic", "onseeked:Dynamic", "onseeking:Dynamic", "onselect:Dynamic", "onselectionchange:Dynamic", "onselectstart:Dynamic", "onslotchange:Dynamic", "onstalled:Dynamic", "onsubmit:Dynamic", "onsuspend:Dynamic", "ontimeupdate:Dynamic", "ontoggle:Dynamic", "ontouchcancel:Dynamic", "ontouchend:Dynamic", "ontouchmove:Dynamic", "ontouchstart:Dynamic", "ontransitioncancel:Dynamic", "ontransitionend:Dynamic", "ontransitionrun:Dynamic", "ontransitionstart:Dynamic", "onvolumechange:Dynamic", "onwaiting:Dynamic", "onwebkitanimationend:Dynamic", "onwebkitanimationiteration:Dynamic", "onwebkitanimationstart:Dynamic", "onwebkittransitionend:Dynamic", "onwheel:Dynamic", "autofocus:Bool", "dataset:DOMStringMap", "nonce:String", "tabIndex:Dynamic", "blur(): Dynamic", "focus(FocusOptions): Dynamic", "accessKey:String", "accessKeyLabel:String", "autocapitalize:String", "autocorrect:Bool", "dir:String", "draggable:Bool", "hidden:Dynamic", "innerText:String", "lang:String", "offsetHeight:Dynamic", "offsetLeft:Dynamic", "offsetParent:Element", "offsetTop:Dynamic", "offsetWidth:Dynamic", "outerText:String", "popover:String", "spellcheck:Bool", "title:String", "translate:Bool", "writingSuggestions:String", "attachInternals(): ElementInternals", "click(): Dynamic", "hidePopover(): Dynamic", "showPopover(ShowPopoverOptions): Dynamic", "togglePopover(Dynamic): Bool", "popoverTargetAction:String", "popoverTargetElement:Element", "command:String", "commandForElement:Element", "disabled:Bool", "form:HTMLFormElement", "formAction:String", "formEnctype:String", "formMethod:String", "formNoValidate:Bool", "formTarget:String", "labels:NodeListOf", "name:String", "type:Dynamic", "validity:ValidityState", "value:String", "willValidate:Bool", "checkValidity(): Bool", "reportValidity(): Bool", "setCustomValidity(String): Dynamic", "addEventListener(K, Dynamic, Dynamic): Dynamic", "addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "removeEventListener(K, Dynamic, Dynamic): Dynamic", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20", "ariaActiveDescendantElement:Element", "ariaAtomic:String", "ariaAutoComplete:String", "ariaBrailleLabel:String", "ariaBrailleRoleDescription:String", "ariaBusy:String", "ariaChecked:String", "ariaColCount:String", "ariaColIndex:String", "ariaColIndexText:String", "ariaColSpan:String", "ariaControlsElements:Array[Element]", "ariaCurrent:String", "ariaDescribedByElements:Array[Element]", "ariaDescription:String", "ariaDetailsElements:Array[Element]", "ariaDisabled:String", "ariaErrorMessageElements:Array[Element]", "ariaExpanded:String", "ariaFlowToElements:Array[Element]", "ariaHasPopup:String", "ariaHidden:String", "ariaInvalid:String", "ariaKeyShortcuts:String", "ariaLabel:String", "ariaLabelledByElements:Array[Element]", "ariaLevel:String", "ariaLive:String", "ariaModal:String", "ariaMultiLine:String", "ariaMultiSelectable:String", "ariaOrientation:String", "ariaOwnsElements:Array[Element]", "ariaPlaceholder:String", "ariaPosInSet:String", "ariaPressed:String", "ariaReadOnly:String", "ariaRelevant:String", "ariaRequired:String", "ariaRoleDescription:String", "ariaRowCount:String", "ariaRowIndex:String", "ariaRowIndexText:String", "ariaRowSpan:String", "ariaSelected:String", "ariaSetSize:String", "ariaSort:String", "ariaValueMax:String", "ariaValueMin:String", "ariaValueNow:String", "ariaValueText:String", "role:String", "animate(Dynamic, Dynamic): Animation", "getAnimations(GetAnimationsOptions): Array[Animation]", "after(Dynamic): Dynamic", "before(Dynamic): Dynamic", "remove(): Dynamic", "replaceWith(Dynamic): Dynamic", "nextElementSibling:Element", "previousElementSibling:Element", "childElementCount:Dynamic", "children:HTMLCollection", "firstElementChild:Element", "lastElementChild:Element", "append(Dynamic): Dynamic", "moveBefore(Node, Node): Dynamic", "prepend(Dynamic): Dynamic", "querySelector(K): Dynamic", "querySelectorAll(K): NodeListOf", "replaceChildren(Dynamic): Dynamic", "assignedSlot:HTMLSlotElement", "attributes:NamedNodeMap", "classList:DOMTokenList", "className:String", "clientHeight:Dynamic", "clientLeft:Dynamic", "clientTop:Dynamic", "clientWidth:Dynamic", "currentCSSZoom:Dynamic", "customElementRegistry:CustomElementRegistry", "id:String", "innerHTML:String", "localName:String", "namespaceURI:String", "onfullscreenchange:Dynamic", "onfullscreenerror:Dynamic", "outerHTML:String", "part:DOMTokenList", "prefix:String", "scrollHeight:Dynamic", "scrollLeft:Dynamic", "scrollTop:Dynamic", "scrollWidth:Dynamic", "shadowRoot:ShadowRoot", "slot:String", "tagName:String", "attachShadow(ShadowRootInit): ShadowRoot", "checkVisibility(CheckVisibilityOptions): Bool", "closest(K): Dynamic", "computedStyleMap(): StylePropertyMapReadOnly", "getAttribute(String): String", "getAttributeNS(String, String): String", "getAttributeNames(): Array[String]", "getAttributeNode(String): Attr", "getAttributeNodeNS(String, String): Attr", "getBoundingClientRect(): DOMRect", "getClientRects(): DOMRectList", "getElementsByClassName(String): HTMLCollectionOf", "getElementsByTagName(K): HTMLCollectionOf", "getElementsByTagNameNS(String): HTMLCollectionOf", "getHTML(GetHTMLOptions): String", "hasAttribute(String): Bool", "hasAttributeNS(String, String): Bool", "hasAttributes(): Bool", "hasPointerCapture(Dynamic): Bool", "insertAdjacentElement(InsertPosition, Element): Element", "insertAdjacentHTML(InsertPosition, String): Dynamic", "insertAdjacentText(InsertPosition, String): Dynamic", "matches(K): Dynamic", "releasePointerCapture(Dynamic): Dynamic", "removeAttribute(String): Dynamic", "removeAttributeNS(String, String): Dynamic", "removeAttributeNode(Attr): Attr", "requestFullscreen(FullscreenOptions): Promise", "requestPointerLock(PointerLockOptions): Promise", "scroll(ScrollToOptions): Dynamic", "scrollBy(ScrollToOptions): Dynamic", "scrollIntoView(Dynamic): Dynamic", "scrollTo(ScrollToOptions): Dynamic", "setAttribute(String, String): Dynamic", "setAttributeNS(String, String, String): Dynamic", "setAttributeNode(Attr): Attr", "setAttributeNodeNS(Attr): Attr", "setHTMLUnsafe(String): Dynamic", "setPointerCapture(Dynamic): Dynamic", "toggleAttribute(String, Bool): Bool", "webkitMatchesSelector(String): Bool", "attributeStyleMap:StylePropertyMap", "style:CSSStyleDeclaration", "contentEditable:String", "enterKeyHint:String", "inputMode:String", "isContentEditable:Bool", "onabort:Dynamic", "onanimationcancel:Dynamic", "onanimationend:Dynamic", "onanimationiteration:Dynamic", "onanimationstart:Dynamic", "onauxclick:Dynamic", "onbeforeinput:Dynamic", "onbeforematch:Dynamic", "onbeforetoggle:Dynamic", "onblur:Dynamic", "oncancel:Dynamic", "oncanplay:Dynamic", "oncanplaythrough:Dynamic", "onchange:Dynamic", "onclick:Dynamic", "onclose:Dynamic", "oncommand:Dynamic", "oncontextlost:Dynamic", "oncontextmenu:Dynamic", "oncontextrestored:Dynamic", "oncopy:Dynamic", "oncuechange:Dynamic", "oncut:Dynamic", "ondblclick:Dynamic", "ondrag:Dynamic", "ondragend:Dynamic", "ondragenter:Dynamic", "ondragleave:Dynamic", "ondragover:Dynamic", "ondragstart:Dynamic", "ondrop:Dynamic", "ondurationchange:Dynamic", "onemptied:Dynamic", "onended:Dynamic", "onerror:OnErrorEventHandler", "onfocus:Dynamic", "onformdata:Dynamic", "ongotpointercapture:Dynamic", "oninput:Dynamic", "oninvalid:Dynamic", "onkeydown:Dynamic", "onkeypress:Dynamic", "onkeyup:Dynamic", "onload:Dynamic", "onloadeddata:Dynamic", "onloadedmetadata:Dynamic", "onloadstart:Dynamic", "onlostpointercapture:Dynamic", "onmousedown:Dynamic", "onmouseenter:Dynamic", "onmouseleave:Dynamic", "onmousemove:Dynamic", "onmouseout:Dynamic", "onmouseover:Dynamic", "onmouseup:Dynamic", "onpaste:Dynamic", "onpause:Dynamic", "onplay:Dynamic", "onplaying:Dynamic", "onpointercancel:Dynamic", "onpointerdown:Dynamic", "onpointerenter:Dynamic", "onpointerleave:Dynamic", "onpointermove:Dynamic", "onpointerout:Dynamic", "onpointerover:Dynamic", "onpointerrawupdate:Dynamic", "onpointerup:Dynamic", "onprogress:Dynamic", "onratechange:Dynamic", "onreset:Dynamic", "onresize:Dynamic", "onscroll:Dynamic", "onscrollend:Dynamic", "onsecuritypolicyviolation:Dynamic", "onseeked:Dynamic", "onseeking:Dynamic", "onselect:Dynamic", "onselectionchange:Dynamic", "onselectstart:Dynamic", "onslotchange:Dynamic", "onstalled:Dynamic", "onsubmit:Dynamic", "onsuspend:Dynamic", "ontimeupdate:Dynamic", "ontoggle:Dynamic", "ontouchcancel:Dynamic", "ontouchend:Dynamic", "ontouchmove:Dynamic", "ontouchstart:Dynamic", "ontransitioncancel:Dynamic", "ontransitionend:Dynamic", "ontransitionrun:Dynamic", "ontransitionstart:Dynamic", "onvolumechange:Dynamic", "onwaiting:Dynamic", "onwebkitanimationend:Dynamic", "onwebkitanimationiteration:Dynamic", "onwebkitanimationstart:Dynamic", "onwebkittransitionend:Dynamic", "onwheel:Dynamic", "autofocus:Bool", "dataset:DOMStringMap", "nonce:String", "tabIndex:Dynamic", "blur(): Dynamic", "focus(FocusOptions): Dynamic", "accessKey:String", "accessKeyLabel:String", "autocapitalize:String", "autocorrect:Bool", "dir:String", "draggable:Bool", "hidden:Dynamic", "innerText:String", "lang:String", "offsetHeight:Dynamic", "offsetLeft:Dynamic", "offsetParent:Element", "offsetTop:Dynamic", "offsetWidth:Dynamic", "outerText:String", "popover:String", "spellcheck:Bool", "title:String", "translate:Bool", "writingSuggestions:String", "attachInternals(): ElementInternals", "click(): Dynamic", "hidePopover(): Dynamic", "showPopover(ShowPopoverOptions): Dynamic", "togglePopover(Dynamic): Bool", "popoverTargetAction:String", "popoverTargetElement:Element", "accept:String", "align:String", "alt:String", "autocomplete:AutoFill", "capture:String", "checked:Bool", "defaultChecked:Bool", "defaultValue:String", "dirName:String", "disabled:Bool", "files:FileList", "form:HTMLFormElement", "formAction:String", "formEnctype:String", "formMethod:String", "formNoValidate:Bool", "formTarget:String", "height:Dynamic", "indeterminate:Bool", "labels:NodeListOf", "list:HTMLDataListElement", "max:String", "maxLength:Dynamic", "min:String", "minLength:Dynamic", "multiple:Bool", "name:String", "pattern:String", "placeholder:String", "readOnly:Bool", "required:Bool", "selectionDirection:SelectionDirection", "selectionEnd:Dynamic", "selectionStart:Dynamic", "size:Dynamic", "src:String", "step:String", "type:String", "useMap:String", "validationMessage:String", "validity:ValidityState", "value:String", "valueAsDate:Date", "valueAsNumber:Dynamic", "webkitEntries:Array[FileSystemEntry]", "webkitdirectory:Bool", "width:Dynamic", "willValidate:Bool", "checkValidity(): Bool", "reportValidity(): Bool", "select(): Dynamic", "setCustomValidity(String): Dynamic", "setRangeText(String): Dynamic", "setRangeText(String, Dynamic, Dynamic, SelectionMode): Dynamic", "setSelectionRange(Dynamic, Dynamic, SelectionDirection): Dynamic", "showPicker(): Dynamic", "stepDown(Dynamic): Dynamic", "stepUp(Dynamic): Dynamic", "addEventListener(K, Dynamic, Dynamic): Dynamic", "addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "removeEventListener(K, Dynamic, Dynamic): Dynamic", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20", "ariaActiveDescendantElement:Element", "ariaAtomic:String", "ariaAutoComplete:String", "ariaBrailleLabel:String", "ariaBrailleRoleDescription:String", "ariaBusy:String", "ariaChecked:String", "ariaColCount:String", "ariaColIndex:String", "ariaColIndexText:String", "ariaColSpan:String", "ariaControlsElements:Array[Element]", "ariaCurrent:String", "ariaDescribedByElements:Array[Element]", "ariaDescription:String", "ariaDetailsElements:Array[Element]", "ariaDisabled:String", "ariaErrorMessageElements:Array[Element]", "ariaExpanded:String", "ariaFlowToElements:Array[Element]", "ariaHasPopup:String", "ariaHidden:String", "ariaInvalid:String", "ariaKeyShortcuts:String", "ariaLabel:String", "ariaLabelledByElements:Array[Element]", "ariaLevel:String", "ariaLive:String", "ariaModal:String", "ariaMultiLine:String", "ariaMultiSelectable:String", "ariaOrientation:String", "ariaOwnsElements:Array[Element]", "ariaPlaceholder:String", "ariaPosInSet:String", "ariaPressed:String", "ariaReadOnly:String", "ariaRelevant:String", "ariaRequired:String", "ariaRoleDescription:String", "ariaRowCount:String", "ariaRowIndex:String", "ariaRowIndexText:String", "ariaRowSpan:String", "ariaSelected:String", "ariaSetSize:String", "ariaSort:String", "ariaValueMax:String", "ariaValueMin:String", "ariaValueNow:String", "ariaValueText:String", "role:String", "animate(Dynamic, Dynamic): Animation", "getAnimations(GetAnimationsOptions): Array[Animation]", "after(Dynamic): Dynamic", "before(Dynamic): Dynamic", "remove(): Dynamic", "replaceWith(Dynamic): Dynamic", "nextElementSibling:Element", "previousElementSibling:Element", "childElementCount:Dynamic", "children:HTMLCollection", "firstElementChild:Element", "lastElementChild:Element", "append(Dynamic): Dynamic", "moveBefore(Node, Node): Dynamic", "prepend(Dynamic): Dynamic", "querySelector(K): Dynamic", "querySelectorAll(K): NodeListOf", "replaceChildren(Dynamic): Dynamic", "assignedSlot:HTMLSlotElement", "attributes:NamedNodeMap", "classList:DOMTokenList", "className:String", "clientHeight:Dynamic", "clientLeft:Dynamic", "clientTop:Dynamic", "clientWidth:Dynamic", "currentCSSZoom:Dynamic", "customElementRegistry:CustomElementRegistry", "id:String", "innerHTML:String", "localName:String", "namespaceURI:String", "onfullscreenchange:Dynamic", "onfullscreenerror:Dynamic", "outerHTML:String", "part:DOMTokenList", "prefix:String", "scrollHeight:Dynamic", "scrollLeft:Dynamic", "scrollTop:Dynamic", "scrollWidth:Dynamic", "shadowRoot:ShadowRoot", "slot:String", "tagName:String", "attachShadow(ShadowRootInit): ShadowRoot", "checkVisibility(CheckVisibilityOptions): Bool", "closest(K): Dynamic", "computedStyleMap(): StylePropertyMapReadOnly", "getAttribute(String): String", "getAttributeNS(String, String): String", "getAttributeNames(): Array[String]", "getAttributeNode(String): Attr", "getAttributeNodeNS(String, String): Attr", "getBoundingClientRect(): DOMRect", "getClientRects(): DOMRectList", "getElementsByClassName(String): HTMLCollectionOf", "getElementsByTagName(K): HTMLCollectionOf", "getElementsByTagNameNS(String): HTMLCollectionOf", "getHTML(GetHTMLOptions): String", "hasAttribute(String): Bool", "hasAttributeNS(String, String): Bool", "hasAttributes(): Bool", "hasPointerCapture(Dynamic): Bool", "insertAdjacentElement(InsertPosition, Element): Element", "insertAdjacentHTML(InsertPosition, String): Dynamic", "insertAdjacentText(InsertPosition, String): Dynamic", "matches(K): Dynamic", "releasePointerCapture(Dynamic): Dynamic", "removeAttribute(String): Dynamic", "removeAttributeNS(String, String): Dynamic", "removeAttributeNode(Attr): Attr", "requestFullscreen(FullscreenOptions): Promise", "requestPointerLock(PointerLockOptions): Promise", "scroll(ScrollToOptions): Dynamic", "scrollBy(ScrollToOptions): Dynamic", "scrollIntoView(Dynamic): Dynamic", "scrollTo(ScrollToOptions): Dynamic", "setAttribute(String, String): Dynamic", "setAttributeNS(String, String, String): Dynamic", "setAttributeNode(Attr): Attr", "setAttributeNodeNS(Attr): Attr", "setHTMLUnsafe(String): Dynamic", "setPointerCapture(Dynamic): Dynamic", "toggleAttribute(String, Bool): Bool", "webkitMatchesSelector(String): Bool", "attributeStyleMap:StylePropertyMap", "style:CSSStyleDeclaration", "contentEditable:String", "enterKeyHint:String", "inputMode:String", "isContentEditable:Bool", "onabort:Dynamic", "onanimationcancel:Dynamic", "onanimationend:Dynamic", "onanimationiteration:Dynamic", "onanimationstart:Dynamic", "onauxclick:Dynamic", "onbeforeinput:Dynamic", "onbeforematch:Dynamic", "onbeforetoggle:Dynamic", "onblur:Dynamic", "oncancel:Dynamic", "oncanplay:Dynamic", "oncanplaythrough:Dynamic", "onchange:Dynamic", "onclick:Dynamic", "onclose:Dynamic", "oncommand:Dynamic", "oncontextlost:Dynamic", "oncontextmenu:Dynamic", "oncontextrestored:Dynamic", "oncopy:Dynamic", "oncuechange:Dynamic", "oncut:Dynamic", "ondblclick:Dynamic", "ondrag:Dynamic", "ondragend:Dynamic", "ondragenter:Dynamic", "ondragleave:Dynamic", "ondragover:Dynamic", "ondragstart:Dynamic", "ondrop:Dynamic", "ondurationchange:Dynamic", "onemptied:Dynamic", "onended:Dynamic", "onerror:OnErrorEventHandler", "onfocus:Dynamic", "onformdata:Dynamic", "ongotpointercapture:Dynamic", "oninput:Dynamic", "oninvalid:Dynamic", "onkeydown:Dynamic", "onkeypress:Dynamic", "onkeyup:Dynamic", "onload:Dynamic", "onloadeddata:Dynamic", "onloadedmetadata:Dynamic", "onloadstart:Dynamic", "onlostpointercapture:Dynamic", "onmousedown:Dynamic", "onmouseenter:Dynamic", "onmouseleave:Dynamic", "onmousemove:Dynamic", "onmouseout:Dynamic", "onmouseover:Dynamic", "onmouseup:Dynamic", "onpaste:Dynamic", "onpause:Dynamic", "onplay:Dynamic", "onplaying:Dynamic", "onpointercancel:Dynamic", "onpointerdown:Dynamic", "onpointerenter:Dynamic", "onpointerleave:Dynamic", "onpointermove:Dynamic", "onpointerout:Dynamic", "onpointerover:Dynamic", "onpointerrawupdate:Dynamic", "onpointerup:Dynamic", "onprogress:Dynamic", "onratechange:Dynamic", "onreset:Dynamic", "onresize:Dynamic", "onscroll:Dynamic", "onscrollend:Dynamic", "onsecuritypolicyviolation:Dynamic", "onseeked:Dynamic", "onseeking:Dynamic", "onselect:Dynamic", "onselectionchange:Dynamic", "onselectstart:Dynamic", "onslotchange:Dynamic", "onstalled:Dynamic", "onsubmit:Dynamic", "onsuspend:Dynamic", "ontimeupdate:Dynamic", "ontoggle:Dynamic", "ontouchcancel:Dynamic", "ontouchend:Dynamic", "ontouchmove:Dynamic", "ontouchstart:Dynamic", "ontransitioncancel:Dynamic", "ontransitionend:Dynamic", "ontransitionrun:Dynamic", "ontransitionstart:Dynamic", "onvolumechange:Dynamic", "onwaiting:Dynamic", "onwebkitanimationend:Dynamic", "onwebkitanimationiteration:Dynamic", "onwebkitanimationstart:Dynamic", "onwebkittransitionend:Dynamic", "onwheel:Dynamic", "autofocus:Bool", "dataset:DOMStringMap", "nonce:String", "tabIndex:Dynamic", "blur(): Dynamic", "focus(FocusOptions): Dynamic", "accessKey:String", "accessKeyLabel:String", "autocapitalize:String", "autocorrect:Bool", "dir:String", "draggable:Bool", "hidden:Dynamic", "innerText:String", "lang:String", "offsetHeight:Dynamic", "offsetLeft:Dynamic", "offsetParent:Element", "offsetTop:Dynamic", "offsetWidth:Dynamic", "outerText:String", "popover:String", "spellcheck:Bool", "title:String", "translate:Bool", "writingSuggestions:String", "attachInternals(): ElementInternals", "click(): Dynamic", "hidePopover(): Dynamic", "showPopover(ShowPopoverOptions): Dynamic", "togglePopover(Dynamic): Bool", "defaultSelected:Bool", "disabled:Bool", "form:HTMLFormElement", "index:Dynamic", "label:String", "selected:Bool", "text:String", "value:String", "addEventListener(K, Dynamic, Dynamic): Dynamic", "addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "removeEventListener(K, Dynamic, Dynamic): Dynamic", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20", "ariaActiveDescendantElement:Element", "ariaAtomic:String", "ariaAutoComplete:String", "ariaBrailleLabel:String", "ariaBrailleRoleDescription:String", "ariaBusy:String", "ariaChecked:String", "ariaColCount:String", "ariaColIndex:String", "ariaColIndexText:String", "ariaColSpan:String", "ariaControlsElements:Array[Element]", "ariaCurrent:String", "ariaDescribedByElements:Array[Element]", "ariaDescription:String", "ariaDetailsElements:Array[Element]", "ariaDisabled:String", "ariaErrorMessageElements:Array[Element]", "ariaExpanded:String", "ariaFlowToElements:Array[Element]", "ariaHasPopup:String", "ariaHidden:String", "ariaInvalid:String", "ariaKeyShortcuts:String", "ariaLabel:String", "ariaLabelledByElements:Array[Element]", "ariaLevel:String", "ariaLive:String", "ariaModal:String", "ariaMultiLine:String", "ariaMultiSelectable:String", "ariaOrientation:String", "ariaOwnsElements:Array[Element]", "ariaPlaceholder:String", "ariaPosInSet:String", "ariaPressed:String", "ariaReadOnly:String", "ariaRelevant:String", "ariaRequired:String", "ariaRoleDescription:String", "ariaRowCount:String", "ariaRowIndex:String", "ariaRowIndexText:String", "ariaRowSpan:String", "ariaSelected:String", "ariaSetSize:String", "ariaSort:String", "ariaValueMax:String", "ariaValueMin:String", "ariaValueNow:String", "ariaValueText:String", "role:String", "animate(Dynamic, Dynamic): Animation", "getAnimations(GetAnimationsOptions): Array[Animation]", "after(Dynamic): Dynamic", "before(Dynamic): Dynamic", "remove(): Dynamic", "replaceWith(Dynamic): Dynamic", "nextElementSibling:Element", "previousElementSibling:Element", "childElementCount:Dynamic", "children:HTMLCollection", "firstElementChild:Element", "lastElementChild:Element", "append(Dynamic): Dynamic", "moveBefore(Node, Node): Dynamic", "prepend(Dynamic): Dynamic", "querySelector(K): Dynamic", "querySelectorAll(K): NodeListOf", "replaceChildren(Dynamic): Dynamic", "assignedSlot:HTMLSlotElement", "attributes:NamedNodeMap", "classList:DOMTokenList", "className:String", "clientHeight:Dynamic", "clientLeft:Dynamic", "clientTop:Dynamic", "clientWidth:Dynamic", "currentCSSZoom:Dynamic", "customElementRegistry:CustomElementRegistry", "id:String", "innerHTML:String", "localName:String", "namespaceURI:String", "onfullscreenchange:Dynamic", "onfullscreenerror:Dynamic", "outerHTML:String", "part:DOMTokenList", "prefix:String", "scrollHeight:Dynamic", "scrollLeft:Dynamic", "scrollTop:Dynamic", "scrollWidth:Dynamic", "shadowRoot:ShadowRoot", "slot:String", "tagName:String", "attachShadow(ShadowRootInit): ShadowRoot", "checkVisibility(CheckVisibilityOptions): Bool", "closest(K): Dynamic", "computedStyleMap(): StylePropertyMapReadOnly", "getAttribute(String): String", "getAttributeNS(String, String): String", "getAttributeNames(): Array[String]", "getAttributeNode(String): Attr", "getAttributeNodeNS(String, String): Attr", "getBoundingClientRect(): DOMRect", "getClientRects(): DOMRectList", "getElementsByClassName(String): HTMLCollectionOf", "getElementsByTagName(K): HTMLCollectionOf", "getElementsByTagNameNS(String): HTMLCollectionOf", "getHTML(GetHTMLOptions): String", "hasAttribute(String): Bool", "hasAttributeNS(String, String): Bool", "hasAttributes(): Bool", "hasPointerCapture(Dynamic): Bool", "insertAdjacentElement(InsertPosition, Element): Element", "insertAdjacentHTML(InsertPosition, String): Dynamic", "insertAdjacentText(InsertPosition, String): Dynamic", "matches(K): Dynamic", "releasePointerCapture(Dynamic): Dynamic", "removeAttribute(String): Dynamic", "removeAttributeNS(String, String): Dynamic", "removeAttributeNode(Attr): Attr", "requestFullscreen(FullscreenOptions): Promise", "requestPointerLock(PointerLockOptions): Promise", "scroll(ScrollToOptions): Dynamic", "scrollBy(ScrollToOptions): Dynamic", "scrollIntoView(Dynamic): Dynamic", "scrollTo(ScrollToOptions): Dynamic", "setAttribute(String, String): Dynamic", "setAttributeNS(String, String, String): Dynamic", "setAttributeNode(Attr): Attr", "setAttributeNodeNS(Attr): Attr", "setHTMLUnsafe(String): Dynamic", "setPointerCapture(Dynamic): Dynamic", "toggleAttribute(String, Bool): Bool", "webkitMatchesSelector(String): Bool", "attributeStyleMap:StylePropertyMap", "style:CSSStyleDeclaration", "contentEditable:String", "enterKeyHint:String", "inputMode:String", "isContentEditable:Bool", "onabort:Dynamic", "onanimationcancel:Dynamic", "onanimationend:Dynamic", "onanimationiteration:Dynamic", "onanimationstart:Dynamic", "onauxclick:Dynamic", "onbeforeinput:Dynamic", "onbeforematch:Dynamic", "onbeforetoggle:Dynamic", "onblur:Dynamic", "oncancel:Dynamic", "oncanplay:Dynamic", "oncanplaythrough:Dynamic", "onchange:Dynamic", "onclick:Dynamic", "onclose:Dynamic", "oncommand:Dynamic", "oncontextlost:Dynamic", "oncontextmenu:Dynamic", "oncontextrestored:Dynamic", "oncopy:Dynamic", "oncuechange:Dynamic", "oncut:Dynamic", "ondblclick:Dynamic", "ondrag:Dynamic", "ondragend:Dynamic", "ondragenter:Dynamic", "ondragleave:Dynamic", "ondragover:Dynamic", "ondragstart:Dynamic", "ondrop:Dynamic", "ondurationchange:Dynamic", "onemptied:Dynamic", "onended:Dynamic", "onerror:OnErrorEventHandler", "onfocus:Dynamic", "onformdata:Dynamic", "ongotpointercapture:Dynamic", "oninput:Dynamic", "oninvalid:Dynamic", "onkeydown:Dynamic", "onkeypress:Dynamic", "onkeyup:Dynamic", "onload:Dynamic", "onloadeddata:Dynamic", "onloadedmetadata:Dynamic", "onloadstart:Dynamic", "onlostpointercapture:Dynamic", "onmousedown:Dynamic", "onmouseenter:Dynamic", "onmouseleave:Dynamic", "onmousemove:Dynamic", "onmouseout:Dynamic", "onmouseover:Dynamic", "onmouseup:Dynamic", "onpaste:Dynamic", "onpause:Dynamic", "onplay:Dynamic", "onplaying:Dynamic", "onpointercancel:Dynamic", "onpointerdown:Dynamic", "onpointerenter:Dynamic", "onpointerleave:Dynamic", "onpointermove:Dynamic", "onpointerout:Dynamic", "onpointerover:Dynamic", "onpointerrawupdate:Dynamic", "onpointerup:Dynamic", "onprogress:Dynamic", "onratechange:Dynamic", "onreset:Dynamic", "onresize:Dynamic", "onscroll:Dynamic", "onscrollend:Dynamic", "onsecuritypolicyviolation:Dynamic", "onseeked:Dynamic", "onseeking:Dynamic", "onselect:Dynamic", "onselectionchange:Dynamic", "onselectstart:Dynamic", "onslotchange:Dynamic", "onstalled:Dynamic", "onsubmit:Dynamic", "onsuspend:Dynamic", "ontimeupdate:Dynamic", "ontoggle:Dynamic", "ontouchcancel:Dynamic", "ontouchend:Dynamic", "ontouchmove:Dynamic", "ontouchstart:Dynamic", "ontransitioncancel:Dynamic", "ontransitionend:Dynamic", "ontransitionrun:Dynamic", "ontransitionstart:Dynamic", "onvolumechange:Dynamic", "onwaiting:Dynamic", "onwebkitanimationend:Dynamic", "onwebkitanimationiteration:Dynamic", "onwebkitanimationstart:Dynamic", "onwebkittransitionend:Dynamic", "onwheel:Dynamic", "autofocus:Bool", "dataset:DOMStringMap", "nonce:String", "tabIndex:Dynamic", "blur(): Dynamic", "focus(FocusOptions): Dynamic", "accessKey:String", "accessKeyLabel:String", "autocapitalize:String", "autocorrect:Bool", "dir:String", "draggable:Bool", "hidden:Dynamic", "innerText:String", "lang:String", "offsetHeight:Dynamic", "offsetLeft:Dynamic", "offsetParent:Element", "offsetTop:Dynamic", "offsetWidth:Dynamic", "outerText:String", "popover:String", "spellcheck:Bool", "title:String", "translate:Bool", "writingSuggestions:String", "attachInternals(): ElementInternals", "click(): Dynamic", "hidePopover(): Dynamic", "showPopover(ShowPopoverOptions): Dynamic", "togglePopover(Dynamic): Bool", "autocomplete:AutoFill", "disabled:Bool", "form:HTMLFormElement", "labels:NodeListOf", "length:Dynamic", "multiple:Bool", "name:String", "options:HTMLOptionsCollection", "required:Bool", "selectedIndex:Dynamic", "selectedOptions:HTMLCollectionOf", "size:Dynamic", "type:Dynamic", "validity:ValidityState", "value:String", "willValidate:Bool", "add(Dynamic, Dynamic): Dynamic", "checkValidity(): Bool", "item(Dynamic): HTMLOptionElement", "namedItem(String): HTMLOptionElement", "remove(): Dynamic", "remove(Dynamic): Dynamic", "reportValidity(): Bool", "setCustomValidity(String): Dynamic", "showPicker(): Dynamic", "addEventListener(K, Dynamic, Dynamic): Dynamic", "addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "removeEventListener(K, Dynamic, Dynamic): Dynamic", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20", "ariaActiveDescendantElement:Element", "ariaAtomic:String", "ariaAutoComplete:String", "ariaBrailleLabel:String", "ariaBrailleRoleDescription:String", "ariaBusy:String", "ariaChecked:String", "ariaColCount:String", "ariaColIndex:String", "ariaColIndexText:String", "ariaColSpan:String", "ariaControlsElements:Array[Element]", "ariaCurrent:String", "ariaDescribedByElements:Array[Element]", "ariaDescription:String", "ariaDetailsElements:Array[Element]", "ariaDisabled:String", "ariaErrorMessageElements:Array[Element]", "ariaExpanded:String", "ariaFlowToElements:Array[Element]", "ariaHasPopup:String", "ariaHidden:String", "ariaInvalid:String", "ariaKeyShortcuts:String", "ariaLabel:String", "ariaLabelledByElements:Array[Element]", "ariaLevel:String", "ariaLive:String", "ariaModal:String", "ariaMultiLine:String", "ariaMultiSelectable:String", "ariaOrientation:String", "ariaOwnsElements:Array[Element]", "ariaPlaceholder:String", "ariaPosInSet:String", "ariaPressed:String", "ariaReadOnly:String", "ariaRelevant:String", "ariaRequired:String", "ariaRoleDescription:String", "ariaRowCount:String", "ariaRowIndex:String", "ariaRowIndexText:String", "ariaRowSpan:String", "ariaSelected:String", "ariaSetSize:String", "ariaSort:String", "ariaValueMax:String", "ariaValueMin:String", "ariaValueNow:String", "ariaValueText:String", "role:String", "animate(Dynamic, Dynamic): Animation", "getAnimations(GetAnimationsOptions): Array[Animation]", "after(Dynamic): Dynamic", "before(Dynamic): Dynamic", "remove(): Dynamic", "replaceWith(Dynamic): Dynamic", "nextElementSibling:Element", "previousElementSibling:Element", "childElementCount:Dynamic", "children:HTMLCollection", "firstElementChild:Element", "lastElementChild:Element", "append(Dynamic): Dynamic", "moveBefore(Node, Node): Dynamic", "prepend(Dynamic): Dynamic", "querySelector(K): Dynamic", "querySelectorAll(K): NodeListOf", "replaceChildren(Dynamic): Dynamic", "assignedSlot:HTMLSlotElement", "attributes:NamedNodeMap", "classList:DOMTokenList", "className:String", "clientHeight:Dynamic", "clientLeft:Dynamic", "clientTop:Dynamic", "clientWidth:Dynamic", "currentCSSZoom:Dynamic", "customElementRegistry:CustomElementRegistry", "id:String", "innerHTML:String", "localName:String", "namespaceURI:String", "onfullscreenchange:Dynamic", "onfullscreenerror:Dynamic", "outerHTML:String", "part:DOMTokenList", "prefix:String", "scrollHeight:Dynamic", "scrollLeft:Dynamic", "scrollTop:Dynamic", "scrollWidth:Dynamic", "shadowRoot:ShadowRoot", "slot:String", "tagName:String", "attachShadow(ShadowRootInit): ShadowRoot", "checkVisibility(CheckVisibilityOptions): Bool", "closest(K): Dynamic", "computedStyleMap(): StylePropertyMapReadOnly", "getAttribute(String): String", "getAttributeNS(String, String): String", "getAttributeNames(): Array[String]", "getAttributeNode(String): Attr", "getAttributeNodeNS(String, String): Attr", "getBoundingClientRect(): DOMRect", "getClientRects(): DOMRectList", "getElementsByClassName(String): HTMLCollectionOf", "getElementsByTagName(K): HTMLCollectionOf", "getElementsByTagNameNS(String): HTMLCollectionOf", "getHTML(GetHTMLOptions): String", "hasAttribute(String): Bool", "hasAttributeNS(String, String): Bool", "hasAttributes(): Bool", "hasPointerCapture(Dynamic): Bool", "insertAdjacentElement(InsertPosition, Element): Element", "insertAdjacentHTML(InsertPosition, String): Dynamic", "insertAdjacentText(InsertPosition, String): Dynamic", "matches(K): Dynamic", "releasePointerCapture(Dynamic): Dynamic", "removeAttribute(String): Dynamic", "removeAttributeNS(String, String): Dynamic", "removeAttributeNode(Attr): Attr", "requestFullscreen(FullscreenOptions): Promise", "requestPointerLock(PointerLockOptions): Promise", "scroll(ScrollToOptions): Dynamic", "scrollBy(ScrollToOptions): Dynamic", "scrollIntoView(Dynamic): Dynamic", "scrollTo(ScrollToOptions): Dynamic", "setAttribute(String, String): Dynamic", "setAttributeNS(String, String, String): Dynamic", "setAttributeNode(Attr): Attr", "setAttributeNodeNS(Attr): Attr", "setHTMLUnsafe(String): Dynamic", "setPointerCapture(Dynamic): Dynamic", "toggleAttribute(String, Bool): Bool", "webkitMatchesSelector(String): Bool", "attributeStyleMap:StylePropertyMap", "style:CSSStyleDeclaration", "contentEditable:String", "enterKeyHint:String", "inputMode:String", "isContentEditable:Bool", "onabort:Dynamic", "onanimationcancel:Dynamic", "onanimationend:Dynamic", "onanimationiteration:Dynamic", "onanimationstart:Dynamic", "onauxclick:Dynamic", "onbeforeinput:Dynamic", "onbeforematch:Dynamic", "onbeforetoggle:Dynamic", "onblur:Dynamic", "oncancel:Dynamic", "oncanplay:Dynamic", "oncanplaythrough:Dynamic", "onchange:Dynamic", "onclick:Dynamic", "onclose:Dynamic", "oncommand:Dynamic", "oncontextlost:Dynamic", "oncontextmenu:Dynamic", "oncontextrestored:Dynamic", "oncopy:Dynamic", "oncuechange:Dynamic", "oncut:Dynamic", "ondblclick:Dynamic", "ondrag:Dynamic", "ondragend:Dynamic", "ondragenter:Dynamic", "ondragleave:Dynamic", "ondragover:Dynamic", "ondragstart:Dynamic", "ondrop:Dynamic", "ondurationchange:Dynamic", "onemptied:Dynamic", "onended:Dynamic", "onerror:OnErrorEventHandler", "onfocus:Dynamic", "onformdata:Dynamic", "ongotpointercapture:Dynamic", "oninput:Dynamic", "oninvalid:Dynamic", "onkeydown:Dynamic", "onkeypress:Dynamic", "onkeyup:Dynamic", "onload:Dynamic", "onloadeddata:Dynamic", "onloadedmetadata:Dynamic", "onloadstart:Dynamic", "onlostpointercapture:Dynamic", "onmousedown:Dynamic", "onmouseenter:Dynamic", "onmouseleave:Dynamic", "onmousemove:Dynamic", "onmouseout:Dynamic", "onmouseover:Dynamic", "onmouseup:Dynamic", "onpaste:Dynamic", "onpause:Dynamic", "onplay:Dynamic", "onplaying:Dynamic", "onpointercancel:Dynamic", "onpointerdown:Dynamic", "onpointerenter:Dynamic", "onpointerleave:Dynamic", "onpointermove:Dynamic", "onpointerout:Dynamic", "onpointerover:Dynamic", "onpointerrawupdate:Dynamic", "onpointerup:Dynamic", "onprogress:Dynamic", "onratechange:Dynamic", "onreset:Dynamic", "onresize:Dynamic", "onscroll:Dynamic", "onscrollend:Dynamic", "onsecuritypolicyviolation:Dynamic", "onseeked:Dynamic", "onseeking:Dynamic", "onselect:Dynamic", "onselectionchange:Dynamic", "onselectstart:Dynamic", "onslotchange:Dynamic", "onstalled:Dynamic", "onsubmit:Dynamic", "onsuspend:Dynamic", "ontimeupdate:Dynamic", "ontoggle:Dynamic", "ontouchcancel:Dynamic", "ontouchend:Dynamic", "ontouchmove:Dynamic", "ontouchstart:Dynamic", "ontransitioncancel:Dynamic", "ontransitionend:Dynamic", "ontransitionrun:Dynamic", "ontransitionstart:Dynamic", "onvolumechange:Dynamic", "onwaiting:Dynamic", "onwebkitanimationend:Dynamic", "onwebkitanimationiteration:Dynamic", "onwebkitanimationstart:Dynamic", "onwebkittransitionend:Dynamic", "onwheel:Dynamic", "autofocus:Bool", "dataset:DOMStringMap", "nonce:String", "tabIndex:Dynamic", "blur(): Dynamic", "focus(FocusOptions): Dynamic", "accessKey:String", "accessKeyLabel:String", "autocapitalize:String", "autocorrect:Bool", "dir:String", "draggable:Bool", "hidden:Dynamic", "innerText:String", "lang:String", "offsetHeight:Dynamic", "offsetLeft:Dynamic", "offsetParent:Element", "offsetTop:Dynamic", "offsetWidth:Dynamic", "outerText:String", "popover:String", "spellcheck:Bool", "title:String", "translate:Bool", "writingSuggestions:String", "attachInternals(): ElementInternals", "click(): Dynamic", "hidePopover(): Dynamic", "showPopover(ShowPopoverOptions): Dynamic", "togglePopover(Dynamic): Bool", "autocomplete:AutoFill", "cols:Dynamic", "defaultValue:String", "dirName:String", "disabled:Bool", "form:HTMLFormElement", "labels:NodeListOf", "maxLength:Dynamic", "minLength:Dynamic", "name:String", "placeholder:String", "readOnly:Bool", "required:Bool", "rows:Dynamic", "selectionDirection:SelectionDirection", "selectionEnd:Dynamic", "selectionStart:Dynamic", "textLength:Dynamic", "type:String", "validationMessage:String", "validity:ValidityState", "value:String", "willValidate:Bool", "wrap:String", "checkValidity(): Bool", "reportValidity(): Bool", "select(): Dynamic", "setCustomValidity(String): Dynamic", "setRangeText(String): Dynamic", "setRangeText(String, Dynamic, Dynamic, SelectionMode): Dynamic", "setSelectionRange(Dynamic, Dynamic, SelectionDirection): Dynamic", "addEventListener(K, Dynamic, Dynamic): Dynamic", "addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "removeEventListener(K, Dynamic, Dynamic): Dynamic", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "data:String", "dataTransfer:DataTransfer", "inputType:String", "isComposing:Bool", "getTargetRanges(): Array[StaticRange]"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "charCode:Dynamic", "code:String", "ctrlKey:Bool", "isComposing:Bool", "key:String", "keyCode:Dynamic", "location:Dynamic", "metaKey:Bool", "repeat:Bool", "shiftKey:Bool", "getModifierState(String): Bool", "initKeyboardEvent(String, Bool, Bool, Window, String, Dynamic, Bool, Bool, Bool, Bool): Dynamic", "DOM_KEY_LOCATION_STANDARD:0x00", "DOM_KEY_LOCATION_LEFT:0x01", "DOM_KEY_LOCATION_RIGHT:0x02", "DOM_KEY_LOCATION_NUMPAD:0x03"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "button:Dynamic", "buttons:Dynamic", "clientX:Dynamic", "clientY:Dynamic", "ctrlKey:Bool", "layerX:Dynamic", "layerY:Dynamic", "metaKey:Bool", "movementX:Dynamic", "movementY:Dynamic", "offsetX:Dynamic", "offsetY:Dynamic", "pageX:Dynamic", "pageY:Dynamic", "relatedTarget:EventTarget", "screenX:Dynamic", "screenY:Dynamic", "shiftKey:Bool", "x:Dynamic", "y:Dynamic", "getModifierState(String): Bool", "initMouseEvent(String, Bool, Bool, Window, Dynamic, Dynamic, Dynamic, Dynamic, Dynamic, Bool, Bool, Bool, Bool, Dynamic, EventTarget): Dynamic"}, []string{"addEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "dispatchEvent(Event): Bool", "removeEventListener(String, EventListenerOrEventListenerObject, Dynamic): Dynamic", "baseURI:String", "childNodes:NodeListOf", "firstChild:ChildNode", "isConnected:Bool", "lastChild:ChildNode", "nextSibling:ChildNode", "nodeName:String", "nodeType:Dynamic", "nodeValue:String", "ownerDocument:Document", "parentElement:HTMLElement", "parentNode:ParentNode", "previousSibling:ChildNode", "textContent:String", "appendChild(T): T", "cloneNode(Bool): Node", "compareDocumentPosition(Node): Dynamic", "contains(Node): Bool", "getRootNode(GetRootNodeOptions): Node", "hasChildNodes(): Bool", "insertBefore(T, Node): T", "isDefaultNamespace(String): Bool", "isEqualNode(Node): Bool", "isSameNode(Node): Bool", "lookupNamespaceURI(String): String", "lookupPrefix(String): String", "normalize(): Dynamic", "removeChild(T): T", "replaceChild(Node, T): T", "ELEMENT_NODE:String", "ATTRIBUTE_NODE:String", "TEXT_NODE:String", "CDATA_SECTION_NODE:String", "ENTITY_REFERENCE_NODE:String", "ENTITY_NODE:String", "PROCESSING_INSTRUCTION_NODE:String", "COMMENT_NODE:String", "DOCUMENT_NODE:String", "DOCUMENT_TYPE_NODE:String", "DOCUMENT_FRAGMENT_NODE:String", "NOTATION_NODE:String", "DOCUMENT_POSITION_DISCONNECTED:0x01", "DOCUMENT_POSITION_PRECEDING:0x02", "DOCUMENT_POSITION_FOLLOWING:0x04", "DOCUMENT_POSITION_CONTAINS:0x08", "DOCUMENT_POSITION_CONTAINED_BY:0x10", "DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC:0x20"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "button:Dynamic", "buttons:Dynamic", "clientX:Dynamic", "clientY:Dynamic", "ctrlKey:Bool", "layerX:Dynamic", "layerY:Dynamic", "metaKey:Bool", "movementX:Dynamic", "movementY:Dynamic", "offsetX:Dynamic", "offsetY:Dynamic", "pageX:Dynamic", "pageY:Dynamic", "relatedTarget:EventTarget", "screenX:Dynamic", "screenY:Dynamic", "shiftKey:Bool", "x:Dynamic", "y:Dynamic", "getModifierState(String): Bool", "initMouseEvent(String, Bool, Bool, Window, Dynamic, Dynamic, Dynamic, Dynamic, Dynamic, Bool, Bool, Bool, Bool, Dynamic, EventTarget): Dynamic", "altitudeAngle:Dynamic", "azimuthAngle:Dynamic", "height:Dynamic", "isPrimary:Bool", "persistentDeviceId:Dynamic", "pointerId:Dynamic", "pointerType:String", "pressure:Dynamic", "tangentialPressure:Dynamic", "tiltX:Dynamic", "tiltY:Dynamic", "twist:Dynamic", "width:Dynamic", "getCoalescedEvents(): Array[PointerEvent]", "getPredictedEvents(): Array[PointerEvent]"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "lengthComputable:Bool", "loaded:Dynamic", "total:Dynamic"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "blockedURI:String", "columnNumber:Dynamic", "disposition:SecurityPolicyViolationEventDisposition", "documentURI:String", "effectiveDirective:String", "lineNumber:Dynamic", "originalPolicy:String", "referrer:String", "sample:String", "sourceFile:String", "statusCode:Dynamic", "violatedDirective:String"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "submitter:HTMLElement"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "newState:String", "oldState:String", "source:Element"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "changedTouches:TouchList", "ctrlKey:Bool", "metaKey:Bool", "shiftKey:Bool", "targetTouches:TouchList", "touches:TouchList"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "elapsedTime:Dynamic", "propertyName:String", "pseudoElement:String"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic"}, []string{"bubbles:Bool", "cancelBubble:Bool", "cancelable:Bool", "composed:Bool", "currentTarget:EventTarget", "defaultPrevented:Bool", "eventPhase:Dynamic", "isTrusted:Bool", "returnValue:Bool", "srcElement:EventTarget", "target:EventTarget", "timeStamp:DOMHighResTimeStamp", "type:String", "composedPath(): Array[EventTarget]", "initEvent(String, Bool, Bool): Dynamic", "preventDefault(): Dynamic", "stopImmediatePropagation(): Dynamic", "stopPropagation(): Dynamic", "NONE:String", "CAPTURING_PHASE:String", "AT_TARGET:String", "BUBBLING_PHASE:String", "detail:Dynamic", "view:Window", "which:Dynamic", "initUIEvent(String, Bool, Bool, Window, Dynamic): Dynamic", "altKey:Bool", "button:Dynamic", "buttons:Dynamic", "clientX:Dynamic", "clientY:Dynamic", "ctrlKey:Bool", "layerX:Dynamic", "layerY:Dynamic", "metaKey:Bool", "movementX:Dynamic", "movementY:Dynamic", "offsetX:Dynamic", "offsetY:Dynamic", "pageX:Dynamic", "pageY:Dynamic", "relatedTarget:EventTarget", "screenX:Dynamic", "screenY:Dynamic", "shiftKey:Bool", "x:Dynamic", "y:Dynamic", "getModifierState(String): Bool", "initMouseEvent(String, Bool, Bool, Window, Dynamic, Dynamic, Dynamic, Dynamic, Dynamic, Bool, Bool, Bool, Bool, Dynamic, EventTarget): Dynamic", "deltaMode:Dynamic", "deltaX:Dynamic", "deltaY:Dynamic", "deltaZ:Dynamic", "DOM_DELTA_PIXEL:0x00", "DOM_DELTA_LINE:0x01", "DOM_DELTA_PAGE:0x02"}}
...
func selfhost_format_format_formatParsedFile(file ParsedFile) string {
	return selfhost_format_format_formatParsedConstants(file.constants, 0, "") + selfhost_format_format_formatParsedFunctions(file.functions, 0, "")
}

func selfhost_format_format_formatParsedConstants(constants []ParsedConst, index int, out string) string {
	for {
		if index >= len(constants) {
			return out
		} else {
			constants, index, out = constants, index+1, out+selfhost_format_format_formatParsedConstant(constants[index])+"\n"
			continue
		}
	}
}

func selfhost_format_format_formatParsedConstant(constant ParsedConst) string {
	return func() string {
		if constant.private {
			return constant.name + " := " + selfhost_format_format_formatExpr(constant.value, 0)
		}
		return "+ " + constant.name + " := " + selfhost_format_format_formatExpr(constant.value, 0)
	}()
}
...
func selfhost_format_format_formatExpr(expr ParsedExpr, indent int) string {
	return func() string {
		...
		case expr.kind == ExprKind_Block:
			return selfhost_format_format_formatBlockExpr(expr, indent)
		case expr.kind == ExprKind_PatternBlock:
			return selfhost_format_format_formatBlockExpr(expr, indent)
		case expr.kind == ExprKind_Let:
		...
		case expr.kind == ExprKind_Lambda:
			return selfhost_format_format_formatLambdaExpr(expr, indent)
		case expr.kind == ExprKind_Call:
...
func selfhost_format_format_formatBlockExpr(expr ParsedExpr, indent int) string {
	return "{\n" + selfhost_format_format_formatBlockChildren(expr.children, 0, indent+1, "") + selfhost_format_format_indentText(indent) + "}"
}
...
func selfhost_format_format_formatLambdaExpr(expr ParsedExpr, indent int) string {
	return "() => " + selfhost_format_format_formatExpr(expr.children[0], indent)
}
...
func selfhost_format_format_formatXMLElement(element ParsedExpr, indent int) string {
	attrs := selfhost_format_format_formatXMLAttributes(element.children, 0, indent, "")
...
func selfhost_format_format_formatXMLAttributes(children []ParsedExpr, index int, indent int, out string) string {
	for {
		if index >= len(children) {
			return out
		} else {
			if selfhost_format_format_isXMLAttribute(children[index]) {
				children, index, indent, out = children, index+1, indent, out+" "+selfhost_format_format_formatXMLAttribute(children[index], indent)
				continue
			} else {
				children, index, indent, out = children, index+1, indent, out
				continue
			}
		}
	}
...
func selfhost_format_format_formatXMLAttribute(attr ParsedExpr, indent int) string {
	name := func() string {
		if attr.op == "xmlEvent" {
			return "@" + attr.name
		}
	...
	return func() string {
		...
		return name + "={" + selfhost_format_format_formatXMLAttributeValue(attr.children[0], indent) + "}"
	}()
}

func selfhost_format_format_formatXMLAttributeValue(value ParsedExpr, indent int) string {
	return func() string {
		switch {
		case value.kind == ExprKind_Object:
			return selfhost_format_format_formatObjectExpr(value, indent)
		default:
			return selfhost_format_format_formatExpr(value, indent)
		}
	}()
}
...
func selfhost_compiler_ts_rewriteTSStructs(structs []IRStructType, allStructs []IRStructType, enums []IREnumType) []IRStructType {
	...
	for _, typeDecl := range structs {
		_ = typeDecl
		func() int {
			out = append(out, IRStructType{name: typeDecl.name, private: typeDecl.private, generics: typeDecl.generics, fields: typeDecl.fields, sourcePath: typeDecl.sourcePath, line: typeDecl.line, column: typeDecl.column, methods: selfhost_compiler_ts_rewriteTSTypeMethods(typeDecl.methods, typeDecl.name, allStructs, enums)})
			return len(out)
		}()
	}
	return out
...
func selfhost_compiler_ts_rewriteTSConstants(constants []IRConst, structs []IRStructType, enums []IREnumType) []IRConst {
	...
	for _, constant := range constants {
		...
		func() int {
			...
			return func() int {
				out = append(out, IRConst{name: constant.name, private: constant.private, typeName: constant.typeName, line: constant.line, column: constant.column, value: value})
				return len(out)
			}()
		}()
	}
...
func selfhost_compiler_ts_rewriteTSTests(tests []IRTest, structs []IRStructType, enums []IREnumType) []IRTest {
	...
	for _, test := range tests {
		...
		func() int {
			...
			return func() int {
				out = append(out, IRTest{name: test.name, line: test.line, column: test.column, body: body})
				return len(out)
			}()
		}()
	}
...
func selfhost_compiler_ts_tsBuildMethodCall(expr IRExpr, receiverType string, methodName string, receiver IRExpr, args []IRExpr) IRExpr {
	...
	return IRExpr{kind: expr.kind, text: expr.text, name: expr.name, value: expr.value, op: expr.op, params: expr.params, line: expr.line, column: expr.column, children: selfhost_compiler_ts_tsCallChildren(calleeIdent, receiver, args)}
}
...
func compilerDomEventType(name string) string {
	return selfhost_compiler_dom_compilerDomEventTypeAt(name, 0)
}

func selfhost_compiler_dom_compilerDomEventTypeAt(name string, index int) string {
	return func() string {
		if index >= len(selfhost_compiler_dom_types_DOM_EVENT_NAMES) {
			return "Event"
		}
		return selfhost_compiler_dom_compilerDomEventTypeStep(name, index)
	}()
}

func selfhost_compiler_dom_compilerDomEventTypeStep(name string, index int) string {
	return func() string {
		if selfhost_compiler_dom_types_DOM_EVENT_NAMES[index] == name {
			return selfhost_compiler_dom_types_DOM_EVENT_TYPE_NAMES[index]
		}
		return selfhost_compiler_dom_compilerDomEventTypeAt(name, index+1)
	}()
}

func compilerDomTargetType(tag string) string {
	elem := selfhost_compiler_dom_compilerDomElementType(tag, 0)
	hasStruct := selfhost_compiler_dom_compilerDomStructIndex(elem, 0) >= 0
	return func() string {
		if hasStruct {
			return elem
		}
...
func selfhost_compiler_dom_compilerDomElementType(tag string, index int) string {
	return func() string {
		if index >= len(selfhost_compiler_dom_types_DOM_TAG_NAMES) {
			return "EventTarget"
		}
		return selfhost_compiler_dom_compilerDomElementTypeStep(tag, index)
	}()
}

func selfhost_compiler_dom_compilerDomElementTypeStep(tag string, index int) string {
	return func() string {
		if selfhost_compiler_dom_types_DOM_TAG_NAMES[index] == tag {
			return selfhost_compiler_dom_types_DOM_TAG_ELEMENT_TYPES[index]
		}
		return selfhost_compiler_dom_compilerDomElementType(tag, index+1)
	}()
}

func compilerDomStructView(name string) IRStructType {
	index := selfhost_compiler_dom_compilerDomStructIndex(name, 0)
	return func() IRStructType {
		if index < 0 {
			return emptyDomStruct()
		}
		return selfhost_compiler_dom_compilerDomBuildStruct(name, selfhost_compiler_dom_types_DOM_STRUCT_MEMBERS[index])
	}()
}

func compilerDomStructViewWithTarget(name string, targetType string) IRStructType {
	index := selfhost_compiler_dom_compilerDomStructIndex(name, 0)
	return func() IRStructType {
		if index < 0 {
			return emptyDomStruct()
		}
		return selfhost_compiler_dom_compilerDomBuildStructWithTarget(name, selfhost_compiler_dom_types_DOM_STRUCT_MEMBERS[index], targetType)
	}()
}

func selfhost_compiler_dom_compilerDomStructIndex(name string, index int) int {
	return func() int {
		if index >= len(selfhost_compiler_dom_types_DOM_STRUCT_NAMES) {
			return -1
		}
		return selfhost_compiler_dom_compilerDomStructIndexStep(name, index)
	}()
}

func selfhost_compiler_dom_compilerDomStructIndexStep(name string, index int) int {
	return func() int {
		if selfhost_compiler_dom_types_DOM_STRUCT_NAMES[index] == name {
			return index
		}
		return selfhost_compiler_dom_compilerDomStructIndex(name, index+1)
	}()
}

func selfhost_compiler_dom_compilerDomBuildStruct(name string, members []string) IRStructType {
	return selfhost_compiler_dom_compilerDomMakeStruct(name, selfhost_compiler_dom_compilerDomCollectFields(members, "", []IRField{}, 0))
}

func selfhost_compiler_dom_compilerDomBuildStructWithTarget(name string, members []string, targetType string) IRStructType {
	return selfhost_compiler_dom_compilerDomMakeStruct(name, selfhost_compiler_dom_compilerDomCollectFields(members, targetType, []IRField{}, 0))
}

func selfhost_compiler_dom_compilerDomMakeStruct(name string, fields []IRField) IRStructType {
	return IRStructType{name: name, private: false, generics: []string{}, fields: fields, methods: []IRFunction{}, sourcePath: "", line: 0, column: 0}
}

func emptyDomStruct() IRStructType {
	return IRStructType{name: "", private: false, generics: []string{}, fields: []IRField{}, methods: []IRFunction{}, sourcePath: "", line: 0, column: 0}
}

func selfhost_compiler_dom_compilerDomCollectFields(members []string, targetType string, acc []IRField, index int) []IRField {
	return func() []IRField {
		if index >= len(members) {
			return acc
		}
		return selfhost_compiler_dom_compilerDomCollectField(members[index], members, targetType, acc, index)
	}()
}

func selfhost_compiler_dom_compilerDomCollectField(member string, members []string, targetType string, acc []IRField, index int) []IRField {
	next := func() []IRField {
		if strings.Contains(member, "(") {
			return acc
		}
		return func() []IRField {
			__rune_spread_out := []IRField{}
			__rune_spread_out = append(__rune_spread_out, acc...)
			__rune_spread_out = append(__rune_spread_out, selfhost_compiler_dom_compilerDomFieldFromRow(member, targetType))
			return __rune_spread_out
		}()
	}()
	return selfhost_compiler_dom_compilerDomCollectFields(members, targetType, next, index+1)
}

func selfhost_compiler_dom_compilerDomFieldFromRow(row string, targetType string) IRField {
	colon := strings.Index(row, ":")
	name := func() string {
		if colon < 0 {
			return strings.TrimSpace(row)
		}
		return strings.TrimSpace((func() string { runes := []rune(row); return string(runes[0:colon]) }()))
	}()
	lineType := func() string {
		if colon < 0 {
			return "Dynamic"
		}
		return strings.TrimSpace((func() string { runes := []rune(row); return string(runes[colon+1 : len([]rune(row))]) }()))
	}()
	isTarget := name == "target" || name == "currentTarget" || name == "srcElement"
	...
	return IRField{name: name, private: false, typeName: typeName, jsonName: name, jsonIgnore: false, line: 0, column: 0}
}
...
func selfhost_compiler_compiler_checkExpr(expr IRExpr, structs []IRStructType, callables []CompilerCallable, errors []string, bindings []CompilerTypeBinding) []string {
	return func() []string {
		...
		case expr.kind == ExprKind_XMLElement:
			return selfhost_compiler_compiler_checkXMLElementExpr(expr, structs, callables, errors, bindings)
		default:
...
func selfhost_compiler_compiler_checkXMLElementExpr(expr IRExpr, structs []IRStructType, callables []CompilerCallable, errors []string, bindings []CompilerTypeBinding) []string {
	return selfhost_compiler_compiler_checkXMLChildExprs(expr.children, 0, expr.name, structs, callables, errors, bindings)
}

func selfhost_compiler_compiler_checkXMLChildExprs(children []IRExpr, index int, tag string, structs []IRStructType, callables []CompilerCallable, errors []string, bindings []CompilerTypeBinding) []string {
	for {
		if index >= len(children) {
			return errors
		} else {
			children, index, tag, structs, callables, errors, bindings = children, index+1, tag, structs, callables, selfhost_compiler_compiler_checkXMLChildExpr(children[index], tag, structs, callables, errors, bindings), bindings
			continue
		}
	}
}

func selfhost_compiler_compiler_checkXMLChildExpr(child IRExpr, tag string, structs []IRStructType, callables []CompilerCallable, errors []string, bindings []CompilerTypeBinding) []string {
	eventAttr := child.kind == ExprKind_Field && child.op == "xmlEvent"
	return func() []string {
		if eventAttr {
			return selfhost_compiler_compiler_checkXMLEventHandler(child, tag, structs, callables, errors, bindings)
		}
		return selfhost_compiler_compiler_checkExpr(child, structs, callables, errors, bindings)
	}()
}

func selfhost_compiler_compiler_checkXMLEventHandler(attr IRExpr, tag string, structs []IRStructType, callables []CompilerCallable, errors []string, bindings []CompilerTypeBinding) []string {
	hasValue := len(attr.children) > 0
	lambda := func() IRExpr {
		if hasValue {
	...
	isLambda := lambda.kind == ExprKind_Lambda
	hasBody := isLambda && len(lambda.children) > 0
	hasParam := isLambda && len(lambda.params) > 0
	eventType := compilerDomEventType(attr.name)
	targetType := compilerDomTargetType(tag)
	narrowed := compilerDomStructViewWithTarget(eventType, targetType)
	narrowedKnown := narrowed.name != ""
	bodyStructs := func() []IRStructType {
		if narrowedKnown {
			return func() []IRStructType {
				__rune_spread_out := []IRStructType{}
				__rune_spread_out = append(__rune_spread_out, narrowed)
				__rune_spread_out = append(__rune_spread_out, structs...)
				return __rune_spread_out
			}()
		}
		return structs
	}()
	withEvent := func() []CompilerTypeBinding {
		if hasParam {
			return selfhost_compiler_compiler_addCompilerValueBinding(bindings, lambda.params[0].name, eventType)
		}
		return bindings
	}()
	return func() []string {
		if hasBody {
			return selfhost_compiler_compiler_checkExpr(lambda.children[0], bodyStructs, callables, errors, withEvent)
		}
		return func() []string {
			if hasValue && !(isLambda) {
				return selfhost_compiler_compiler_checkExpr(attr.children[0], structs, callables, errors, bindings)
			}
			return errors
		}()
	}()
...
func selfhost_compiler_compiler_findCompilerStruct(structs []IRStructType, name string, index int) IRStructType {
	...
	return func() IRStructType {
		if done {
			return compilerDomStructView(name)
		}
...
func selfhost_compiler_compiler_lowerCompilerSource(source string) IRFile {
	return lowerParsed(selfhost_compiler_compiler_expandCompilerMacros(parse(source), []CompilerModuleMacroBinding{}))
}
...
func selfhost_compiler_compiler_compilerCoreMacroBindings(files []SourceFile, index int, bindings []CompilerModuleMacroBinding) []CompilerModuleMacroBinding {
	done := index >= len(files)
	return func() []CompilerModuleMacroBinding {
		if done {
			return bindings
		}
		return selfhost_compiler_compiler_compilerCoreMacroBindings(files, index+1, selfhost_compiler_compiler_compilerCoreFileMacroBindings(files[index], bindings))
	}()
}

func selfhost_compiler_compiler_compilerCoreFileMacroBindings(file SourceFile, bindings []CompilerModuleMacroBinding) []CompilerModuleMacroBinding {
	module := selfhost_compiler_compiler_compilerCoreModuleName(file.path)
	return func() []CompilerModuleMacroBinding {
		if module == "" {
			return bindings
		}
		return selfhost_compiler_compiler_compilerAddModuleMacroFunctions(module, parse(file.source).functions, 0, bindings)
	}()
}

func selfhost_compiler_compiler_compilerCoreModuleName(path string) string {
	slash := strings.LastIndex(path, "/")
	base := func() string { runes := []rune(path); return string(runes[slash+1 : len([]rune(path))]) }()
	dot := strings.LastIndex(base, ".")
	return func() string {
		if dot < 0 {
			return ""
		}
		return func() string { runes := []rune(base); return string(runes[0:dot]) }()
	}()
}

func selfhost_compiler_compiler_compilerAddModuleMacroFunctions(module string, functions []ParsedFunction, index int, bindings []CompilerModuleMacroBinding) []CompilerModuleMacroBinding {
	done := index >= len(functions)
	return func() []CompilerModuleMacroBinding {
		if done {
			return bindings
		}
		return selfhost_compiler_compiler_compilerAddModuleMacroFunctions(module, functions, index+1, func() []CompilerModuleMacroBinding {
			__rune_spread_out := []CompilerModuleMacroBinding{}
			__rune_spread_out = append(__rune_spread_out, bindings...)
			__rune_spread_out = append(__rune_spread_out, CompilerModuleMacroBinding{module: module, binding: selfhost_compiler_compiler_compilerMacroBindingFromFunction(functions[index])})
			return __rune_spread_out
		}())
	}()
}

func selfhost_compiler_compiler_expandCompilerMacros(file ParsedFile, moduleBindings []CompilerModuleMacroBinding) ParsedFile {
	...
	errors := selfhost_compiler_compiler_compilerMacroErrors(file, moduleBindings, file.errors)
...
func selfhost_compiler_compiler_compilerMacroErrors(file ParsedFile, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	...
	return selfhost_compiler_compiler_compilerAnnotationErrors(file, moduleBindings, methodErrors)
}
...
func selfhost_compiler_compiler_compilerAnnotationErrors(file ParsedFile, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	next := selfhost_compiler_compiler_compilerTypeAnnotationErrors(file.types, file.functions, moduleBindings, 0, errors)
	return selfhost_compiler_compiler_compilerFunctionAnnotationErrors(file.functions, file.functions, moduleBindings, 0, next)
}

func selfhost_compiler_compiler_compilerTypeAnnotationErrors(types []ParsedType, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, index int, errors []ParseError) []ParseError {
	done := index >= len(types)
	return func() []ParseError {
		if done {
			return errors
		}
		return selfhost_compiler_compiler_compilerTypeAnnotationErrors(types, functions, moduleBindings, index+1, selfhost_compiler_compiler_compilerTypeAnnotationError(types[index], functions, moduleBindings, errors))
	}()
}

func selfhost_compiler_compiler_compilerTypeAnnotationError(typeDecl ParsedType, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	next := selfhost_compiler_compiler_compilerAnnotationListErrors(typeDecl.annotations, functions, moduleBindings, 0, errors)
	next = selfhost_compiler_compiler_compilerFieldAnnotationErrors(typeDecl.fields, functions, moduleBindings, 0, next)
	next = selfhost_compiler_compiler_compilerEnumMemberAnnotationErrors(typeDecl.members, functions, moduleBindings, 0, next)
	return selfhost_compiler_compiler_compilerFunctionAnnotationErrors(typeDecl.methods, functions, moduleBindings, 0, next)
}

func selfhost_compiler_compiler_compilerFieldAnnotationErrors(fields []ParsedField, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, index int, errors []ParseError) []ParseError {
	done := index >= len(fields)
	return func() []ParseError {
		if done {
			return errors
		}
		return selfhost_compiler_compiler_compilerFieldAnnotationErrors(fields, functions, moduleBindings, index+1, selfhost_compiler_compiler_compilerAnnotationListErrors(fields[index].annotations, functions, moduleBindings, 0, errors))
	}()
}

func selfhost_compiler_compiler_compilerEnumMemberAnnotationErrors(members []ParsedEnumMember, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, index int, errors []ParseError) []ParseError {
	done := index >= len(members)
	return func() []ParseError {
		if done {
			return errors
		}
		return selfhost_compiler_compiler_compilerEnumMemberAnnotationErrors(members, functions, moduleBindings, index+1, selfhost_compiler_compiler_compilerAnnotationListErrors(members[index].annotations, functions, moduleBindings, 0, errors))
	}()
}

func selfhost_compiler_compiler_compilerFunctionAnnotationErrors(functions []ParsedFunction, topLevelFunctions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, index int, errors []ParseError) []ParseError {
	done := index >= len(functions)
	return func() []ParseError {
		if done {
			return errors
		}
		return selfhost_compiler_compiler_compilerFunctionAnnotationErrors(functions, topLevelFunctions, moduleBindings, index+1, selfhost_compiler_compiler_compilerAnnotationListErrors(functions[index].annotations, topLevelFunctions, moduleBindings, 0, errors))
	}()
}

func selfhost_compiler_compiler_compilerAnnotationListErrors(annotations []ParsedAnnotation, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, index int, errors []ParseError) []ParseError {
	done := index >= len(annotations)
	return func() []ParseError {
		if done {
			return errors
		}
		return selfhost_compiler_compiler_compilerAnnotationListErrors(annotations, functions, moduleBindings, index+1, selfhost_compiler_compiler_compilerAnnotationError(annotations[index], functions, moduleBindings, errors))
	}()
}

func selfhost_compiler_compiler_compilerAnnotationError(annotation ParsedAnnotation, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	return func() []ParseError {
		switch {
		case annotation.marker == "#":
			return selfhost_compiler_compiler_compilerHashAnnotationError(annotation, functions, moduleBindings, errors)
		default:
			return errors
		}
	}()
...
func selfhost_compiler_compiler_compilerHashAnnotationError(annotation ParsedAnnotation, functions []ParsedFunction, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	return func() []ParseError {
		switch {
		case annotation.module == "":
			return selfhost_compiler_compiler_compilerLocalAnnotationError(annotation, functions, errors)
		default:
			return selfhost_compiler_compiler_compilerModuleAnnotationError(annotation, moduleBindings, errors)
		}
	}()
}
...
func selfhost_compiler_compiler_compilerModuleAnnotationError(annotation ParsedAnnotation, moduleBindings []CompilerModuleMacroBinding, errors []ParseError) []ParseError {
	binding := selfhost_compiler_compiler_compilerFindModuleMacroBinding(moduleBindings, annotation.module, annotation.name, 0).binding
	return func() []ParseError {
		switch {
		case binding.name == "":
			return func() []ParseError {
...
func selfhost_compiler_compiler_compilerFindModuleMacroBinding(bindings []CompilerModuleMacroBinding, module string, name string, index int) CompilerModuleMacroBinding {
	done := index >= len(bindings)
	return func() CompilerModuleMacroBinding {
		if done {
			return selfhost_compiler_compiler_emptyCompilerModuleMacroBinding()
		}
		return func() CompilerModuleMacroBinding {
			if bindings[index].module == module && bindings[index].binding.name == name {
				return bindings[index]
			}
			return selfhost_compiler_compiler_compilerFindModuleMacroBinding(bindings, module, name, index+1)
		}()
	}()
}

func selfhost_compiler_compiler_emptyCompilerModuleMacroBinding() CompilerModuleMacroBinding {
	return CompilerModuleMacroBinding{module: "", binding: selfhost_compiler_compiler_emptyCompilerMacroBinding()}
}
