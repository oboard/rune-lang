								...
								return func() __ExprStep {
									...
									return func() __ExprStep {
										...
										return func() __ExprStep {
											...
											return func() __ExprStep {
												if __minPrec <= 1 && ____rune_private_b990f3d7_parserCheck(__state, __TokenKind_QuestionQuestion) {
													return ____rune_private_b990f3d7_parseQuestionQuestionExpression(__state, __expr, __minPrec)
												}
...
func ____rune_private_b990f3d7_parseQuestionQuestionExpression(__state __ParserState, __expr __ParsedExpr, __minPrec int) __ExprStep {
	return func() __ExprStep {
		if ____rune_private_b990f3d7_questionQuestionIsPostfixUnwrap(__state) {
			return ____rune_private_b990f3d7_parseExpressionLoop(____rune_private_b990f3d7_parseResultUnwrapExpressionQQ(__state, __expr), __minPrec)
		}
		return ____rune_private_b990f3d7_parseBinaryExpression(__state, __expr, __minPrec)
	}()
}
...
func ____rune_private_b990f3d7_parseResultUnwrapExpressionQQ(__state __ParserState, __expr __ParsedExpr) __ExprStep {
	__token := ____rune_private_b990f3d7_parserAdvance(__state)
	return __ExprStep{__state: __token.__state, __expr: ____rune_private_b990f3d7_opNode(__ExprKind_Unwrap, "??", __token.__token, []__ParsedExpr{__expr})}
}
...
func ____rune_private_b990f3d7_questionQuestionIsPostfixUnwrap(__state __ParserState) bool {
	__next := ____rune_private_b990f3d7_parserKindAt(__state, __state.__current+1)
	return __next == __TokenKind_EOF || __next == __TokenKind_Newline || __next == __TokenKind_RParen || __next == __TokenKind_RBracket || __next == __TokenKind_RBrace || __next == __TokenKind_Comma
}
...
func __generateGo(__file __IRFile) string {
	...
	if ____rune_private_8ddf8596_fileUsesTemplate(__file) {
		__out = __out + ____rune_private_8ddf8596_emitGoTemplateHelper()
	}
...
func ____rune_private_8ddf8596_emitGoImports(__file __IRFile) string {
	...
	__imports = ____rune_private_8ddf8596_appendGoImportIf(__imports, ____rune_private_8ddf8596_usesPrintFile(__file) || ____rune_private_8ddf8596_fileUsesTemplate(__file), "fmt")
	...
	__imports = ____rune_private_8ddf8596_appendGoImportIf(__imports, __fileUsesModuleCall(__file, "int.toString") || __fileUsesModuleCall(__file, "bigint.toString") || ____rune_private_8ddf8596_fileUsesToString(__file), "strconv")
...
func ____rune_private_8ddf8596_emitGoTaskUnwrap(__expr __IRExpr) string {
...
func ____rune_private_8ddf8596_emitGoPatternBlock(__file __IRFile, __expr __IRExpr, __returns bool, __returnType string, __level int) string {
	...
	__out = __out + ____rune_private_8ddf8596_emitGoPatternBranches(__file, __expr.__children, 0, __returns, __returnType, __level+1, "")
...
func ____rune_private_8ddf8596_emitGoPatternBranches(__file __IRFile, __branches []__IRExpr, __index int, __returns bool, __returnType string, __level int, __out string) string {
	return func() string {
		...
		return ____rune_private_8ddf8596_emitGoPatternBranches(__file, __branches, __index+1, __returns, __returnType, __level, __out+____rune_private_8ddf8596_emitGoPatternBranch(__file, __branches[__index], __returns, __returnType, __level))
	}()
}

func ____rune_private_8ddf8596_emitGoPatternBranch(__file __IRFile, __branch __IRExpr, __returns bool, __returnType string, __level int) string {
	...
	return __line(__level, __head) + ____rune_private_8ddf8596_emitGoPatternBranchBody(__file, __value, __returns, __returnType, __level+1)
}
...
func ____rune_private_8ddf8596_emitGoExpr(__expr __IRExpr) string {
	return func() string {
		...
		case __expr.__kind == __ExprKind_String:
			return __expr.__value
		case __expr.__kind == __ExprKind_Template:
			return ____rune_private_8ddf8596_emitGoTemplate(__expr)
		case __expr.__kind == __ExprKind_Char:
			return __expr.__value
...
func ____rune_private_8ddf8596_emitGoTemplate(__expr __IRExpr) string {
	...
	__parts := ____rune_private_8ddf8596_goTemplateAccumulate(func() []string { parts := strings.Split(__inner, "<<<RUNE_TEMPLATE_PART>>>"); return parts }(), __expr.__children, 0, append([]string{}, []string{""}[0:0]...))
	return func() string {
		if len(__parts) == 0 {
			return "\"\""
		}
		return ____rune_private_8ddf8596_joinGoTemplateParts(__parts, 0, "")
	}()
}

func ____rune_private_8ddf8596_goTemplateAccumulate(__segments []string, __children []__IRExpr, __index int, __out []string) []string {
	return func() []string {
		if __index >= len(__segments) {
			return __out
		}
		return ____rune_private_8ddf8596_goTemplateAccumulate(__segments, __children, __index+1, ____rune_private_8ddf8596_goTemplateAppendStep(__segments, __children, __index, __out))
	}()
}

func ____rune_private_8ddf8596_goTemplateAppendStep(__segments []string, __children []__IRExpr, __index int, __out []string) []string {
	__withText := func() []string {
		...
		return func() []string {
			...
			out = append(out, ____rune_private_8ddf8596_goStringLiteral(__segments[__index]))
			return out
		}()
	}()
	return func() []string {
		if __index < len(__children) {
			return func() []string {
				...
				out = append(out, "__runeTemplateString("+____rune_private_8ddf8596_emitGoExpr(__children[__index])+")")
				return out
			}()
		}
		return __withText
...
func ____rune_private_8ddf8596_joinGoTemplateParts(__parts []string, __index int, __out string) string {
	return func() string {
		if __index >= len(__parts) {
			return __out
		}
		return ____rune_private_8ddf8596_joinGoTemplateParts(__parts, __index+1, func() string {
			if __index == 0 {
...
func ____rune_private_8ddf8596_goStringLiteral(__raw string) string {
	return "\"" + ____rune_private_8ddf8596_goStringLiteralChars(__raw, 0, "") + "\""
}

func ____rune_private_8ddf8596_goStringLiteralChars(__raw string, __index int, __out string) string {
	return func() string {
		if __index >= len([]rune(__raw)) {
			return __out
		}
		return ____rune_private_8ddf8596_goStringLiteralChar(__raw, __index, __out)
	}()
}

func ____rune_private_8ddf8596_goStringLiteralChar(__raw string, __index int, __out string) string {
	return func() string {
		switch {
		case []rune(__raw)[__index] == '\\' && __index+1 < len([]rune(__raw)) == true:
			return ____rune_private_8ddf8596_goStringLiteralNext(__raw, __index+2, __out+____rune_private_8ddf8596_goStringLiteralEscaped([]rune(__raw)[__index+1]))
		default:
			return ____rune_private_8ddf8596_goStringLiteralNext(__raw, __index+1, __out+____rune_private_8ddf8596_goStringLiteralPlain([]rune(__raw)[__index]))
		}
	}()
}

func ____rune_private_8ddf8596_goStringLiteralEscaped(__ch rune) string {
	return func() string {
		if __ch == 'n' {
			return "\\n"
		}
			...
			return func() string {
				...
				return func() string {
					...
					return func() string {
						...
						return ____rune_private_8ddf8596_goStringLiteralPlain(__ch)
					}()
				}()
			}()
		}()
...
func ____rune_private_8ddf8596_goStringLiteralPlain(__ch rune) string {
	return func() string {
		if __ch == '"' {
			return "\\\""
		}
...
func ____rune_private_8ddf8596_goStringLiteralNext(__raw string, __index int, __out string) string {
	return ____rune_private_8ddf8596_goStringLiteralChars(__raw, __index, __out)
}

func ____rune_private_8ddf8596_emitGoTemplateHelper() string {
		...
		if len(__selector.__children) > 0 && __selector.__children[0].__kind != __ExprKind_At {
			return func() string {
				...
				case (__selector.__name == "toDouble") || (__selector.__name == "toInt"):
					return ____rune_private_8ddf8596_emitGoCoreNumericConversion(__selector.__children[0], __selector.__name)
				case __selector.__name == "toString":
					return ____rune_private_8ddf8596_emitGoCoreToString(__selector.__children[0])
				default:
					return ____rune_private_8ddf8596_emitGoDefaultCall(__expr)
				}
			}()
...
func ____rune_private_8ddf8596_emitGoCoreNumericConversion(__receiver __IRExpr, __method string) string {
	return func() string {
		if __method == "toDouble" {
			return "float64(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + ")"
		}
		return func() string {
			if __method == "toInt" {
				return "int(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + ")"
			}
			return ____rune_private_8ddf8596_emitGoExpr(__receiver)
		}()
	}()
}

func ____rune_private_8ddf8596_emitGoCoreToString(__receiver __IRExpr) string {
	return func() string {
		switch {
		case __receiver.__text == "Bool":
			return "strconv.FormatBool(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + ")"
		case (__receiver.__text == "Int") || (__receiver.__text == "int4") || (__receiver.__text == "int8") || (__receiver.__text == "int16") || (__receiver.__text == "int64") || (__receiver.__text == "uint") || (__receiver.__text == "uint8") || (__receiver.__text == "uint16") || (__receiver.__text == "uint64"):
			return "strconv.Itoa(int(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + "))"
		case __receiver.__text == "Double":
			return "strconv.FormatFloat(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + ", 'f', -1, 64)"
		case __receiver.__text == "Float":
			return "strconv.FormatFloat(float64(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + "), 'f', -1, 32)"
		case __receiver.__text == "Char":
			return "string(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + ")"
		case __receiver.__text == "BigInt":
			return "strconv.FormatInt(int64(" + ____rune_private_8ddf8596_emitGoExpr(__receiver) + "), 10)"
		default:
			return ____rune_private_8ddf8596_emitGoExpr(__receiver)
		}
	}()
...
func ____rune_private_8ddf8596_fileUsesTemplate(__file __IRFile) bool {
	return ____rune_private_8ddf8596_functionsUseTemplate(__file.__functions, 0) || ____rune_private_8ddf8596_structsUseTemplate(__file.__structs, 0) || ____rune_private_8ddf8596_enumsUseTemplate(__file.__enums, 0)
}

func ____rune_private_8ddf8596_functionsUseTemplate(__functions []__IRFunction, __index int) bool {
	return func() bool {
		if __index >= len(__functions) {
			return false
		}
		return func() bool {
			if __functions[__index].__macro {
				return ____rune_private_8ddf8596_functionsUseTemplate(__functions, __index+1)
			}
			return func() bool {
				if ____rune_private_8ddf8596_exprUsesTemplate(__functions[__index].__body) {
					return true
				}
				return ____rune_private_8ddf8596_functionsUseTemplate(__functions, __index+1)
			}()
...
func ____rune_private_8ddf8596_structsUseTemplate(__structs []__IRStructType, __index int) bool {
	return func() bool {
		if __index >= len(__structs) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_functionsUseTemplate(__structs[__index].__methods, 0) {
				return true
			}
			return ____rune_private_8ddf8596_structsUseTemplate(__structs, __index+1)
		}()
	}()
}

func ____rune_private_8ddf8596_enumsUseTemplate(__enums []__IREnumType, __index int) bool {
	return func() bool {
		if __index >= len(__enums) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_functionsUseTemplate(__enums[__index].__methods, 0) {
				return true
			}
			return ____rune_private_8ddf8596_enumsUseTemplate(__enums, __index+1)
		}()
	}()
}

func ____rune_private_8ddf8596_exprUsesTemplate(__expr __IRExpr) bool {
	return __expr.__kind == __ExprKind_Template || ____rune_private_8ddf8596_exprChildrenUseTemplate(__expr.__children, 0)
}

func ____rune_private_8ddf8596_exprChildrenUseTemplate(__children []__IRExpr, __index int) bool {
	return func() bool {
		if __index >= len(__children) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_exprUsesTemplate(__children[__index]) {
				return true
			}
			return ____rune_private_8ddf8596_exprChildrenUseTemplate(__children, __index+1)
		}()
	}()
}

func ____rune_private_8ddf8596_fileUsesToString(__file __IRFile) bool {
	return ____rune_private_8ddf8596_functionsUseToString(__file.__functions, 0) || ____rune_private_8ddf8596_structsUseToString(__file.__structs, 0) || ____rune_private_8ddf8596_enumsUseToString(__file.__enums, 0)
}

func ____rune_private_8ddf8596_functionsUseToString(__functions []__IRFunction, __index int) bool {
	return func() bool {
		if __index >= len(__functions) {
			return false
		}
		return func() bool {
			if __functions[__index].__macro {
				return ____rune_private_8ddf8596_functionsUseToString(__functions, __index+1)
			}
			return func() bool {
				if ____rune_private_8ddf8596_exprUsesToString(__functions[__index].__body) {
					return true
				}
				return ____rune_private_8ddf8596_functionsUseToString(__functions, __index+1)
			}()
...
func ____rune_private_8ddf8596_structsUseToString(__structs []__IRStructType, __index int) bool {
	return func() bool {
		if __index >= len(__structs) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_functionsUseToString(__structs[__index].__methods, 0) {
				return true
			}
			return ____rune_private_8ddf8596_structsUseToString(__structs, __index+1)
		}()
	}()
}

func ____rune_private_8ddf8596_enumsUseToString(__enums []__IREnumType, __index int) bool {
	return func() bool {
		if __index >= len(__enums) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_functionsUseToString(__enums[__index].__methods, 0) {
				return true
			}
			return ____rune_private_8ddf8596_enumsUseToString(__enums, __index+1)
		}()
	}()
}

func ____rune_private_8ddf8596_exprUsesToString(__expr __IRExpr) bool {
	return ____rune_private_8ddf8596_exprIsScalarToStringCall(__expr) || ____rune_private_8ddf8596_exprChildrenUseToString(__expr.__children, 0)
}

func ____rune_private_8ddf8596_exprIsScalarToStringCall(__expr __IRExpr) bool {
	return func() bool {
		if __expr.__kind == __ExprKind_Call && len(__expr.__children) > 0 && __expr.__children[0].__kind == __ExprKind_Selector && __expr.__children[0].__name == "toString" && len(__expr.__children[0].__children) > 0 {
			return ____rune_private_8ddf8596_goScalarToStringReceiver(__expr.__children[0].__children[0].__text)
		}
		return false
	}()
}

func ____rune_private_8ddf8596_goScalarToStringReceiver(__typeName string) bool {
...
func ____rune_private_8ddf8596_exprChildrenUseToString(__children []__IRExpr, __index int) bool {
	return func() bool {
		if __index >= len(__children) {
			return false
		}
		return func() bool {
			if ____rune_private_8ddf8596_exprUsesToString(__children[__index]) {
				return true
			}
			return ____rune_private_8ddf8596_exprChildrenUseToString(__children, __index+1)
		}()
	}()
}
...
func ____rune_private_3050a3c7_emitMoonBitExpr(__expr __IRExpr) string {
	return func() string {
		...
		case __expr.__kind == __ExprKind_String:
			return __expr.__value
		case __expr.__kind == __ExprKind_Template:
			return ____rune_private_3050a3c7_emitMoonBitTemplate(__expr)
		case __expr.__kind == __ExprKind_Char:
			return __expr.__value
		case __expr.__kind == __ExprKind_Regex:
			return __expr.__value
...
func ____rune_private_3050a3c7_emitMoonBitTemplate(__expr __IRExpr) string {
	__raw := __expr.__value
	__inner := func() string {
		if len([]rune(__raw)) >= 2 {
			return func() string { runes := []rune(__raw); return string(runes[1 : len([]rune(__raw))-1]) }()
	...
	__parts := ____rune_private_3050a3c7_mbtTemplateAccumulate(func() []string { parts := strings.Split(__inner, "<<<RUNE_TEMPLATE_PART>>>"); return parts }(), __expr.__children, 0, append([]string{}, []string{""}[0:0]...))
	return func() string {
		if len(__parts) == 0 {
			return "\"\""
		}
		return ____rune_private_3050a3c7_joinMoonBitTemplateParts(__parts, 0, "")
	}()
}

func ____rune_private_3050a3c7_mbtTemplateAccumulate(__segments []string, __children []__IRExpr, __index int, __out []string) []string {
	return func() []string {
		if __index >= len(__segments) {
			return __out
		}
		return ____rune_private_3050a3c7_mbtTemplateAccumulate(__segments, __children, __index+1, ____rune_private_3050a3c7_mbtTemplateAppendStep(__segments, __children, __index, __out))
	}()
}

func ____rune_private_3050a3c7_mbtTemplateAppendStep(__segments []string, __children []__IRExpr, __index int, __out []string) []string {
	__withText := func() []string {
		if len(__segments[__index]) == 0 {
			return __out
		}
		return func() []string {
			out := []string{}
			out = append(out, __out...)
			out = append(out, ____rune_private_3050a3c7_mbtStringLiteral(__segments[__index]))
			return out
		}()
	}()
	return func() []string {
		if __index < len(__children) {
			return func() []string {
				out := []string{}
				out = append(out, __withText...)
				out = append(out, ____rune_private_3050a3c7_mbtTemplateInterpolation(__children[__index]))
				return out
			}()
		}
		return __withText
...
func ____rune_private_3050a3c7_mbtTemplateInterpolation(__child __IRExpr) string {
	return func() string {
		if __child.__text == "String" {
			return ____rune_private_3050a3c7_emitMoonBitExpr(__child)
		}
		return ____rune_private_3050a3c7_emitMoonBitExpr(__child) + ".to_string()"
	}()
}

func ____rune_private_3050a3c7_joinMoonBitTemplateParts(__parts []string, __index int, __out string) string {
	return func() string {
		if __index >= len(__parts) {
			return __out
		}
		return ____rune_private_3050a3c7_joinMoonBitTemplateParts(__parts, __index+1, func() string {
			if __index == 0 {
				return __out + __parts[__index]
			}
			return __out + " + " + __parts[__index]
...
func ____rune_private_3050a3c7_mbtStringLiteral(__raw string) string {
	return "\"" + ____rune_private_3050a3c7_mbtStringLiteralChars(__raw, 0, "") + "\""
}

func ____rune_private_3050a3c7_mbtStringLiteralChars(__raw string, __index int, __out string) string {
	return func() string {
		if __index >= len([]rune(__raw)) {
			return __out
		}
		return ____rune_private_3050a3c7_mbtStringLiteralChar(__raw, __index, __out)
	}()
}

func ____rune_private_3050a3c7_mbtStringLiteralChar(__raw string, __index int, __out string) string {
	return func() string {
		switch {
		case []rune(__raw)[__index] == '\\' && __index+1 < len([]rune(__raw)) == true:
			return ____rune_private_3050a3c7_mbtStringLiteralNext(__raw, __index+2, __out+____rune_private_3050a3c7_mbtStringLiteralEscaped([]rune(__raw)[__index+1]))
		default:
			return ____rune_private_3050a3c7_mbtStringLiteralNext(__raw, __index+1, __out+____rune_private_3050a3c7_mbtStringLiteralPlain([]rune(__raw)[__index]))
		}
	}()
}

func ____rune_private_3050a3c7_mbtStringLiteralEscaped(__ch rune) string {
	return func() string {
		if __ch == 'n' {
			return "\\n"
		}
			...
			return func() string {
				...
				return func() string {
					...
					return func() string {
						...
						return ____rune_private_3050a3c7_mbtStringLiteralPlain(__ch)
					}()
				}()
			}()
		}()
...
func ____rune_private_3050a3c7_mbtStringLiteralPlain(__ch rune) string {
	return func() string {
		if __ch == '"' {
			return "\\\""
		}
...
func ____rune_private_3050a3c7_mbtStringLiteralNext(__raw string, __index int, __out string) string {
	return ____rune_private_3050a3c7_mbtStringLiteralChars(__raw, __index, __out)
}
	...
	return func() string {
		if len(__selector.__children) > 0 && __selector.__children[0].__kind != __ExprKind_At {
			return func() string {
				...
				case __selector.__name == "toString":
					return ____rune_private_3050a3c7_emitMoonBitCoreToString(__expr, __selector.__children[0])
				default:
					return ____rune_private_3050a3c7_emitMoonBitDefaultCall(__expr)
				}
			}()
...
func ____rune_private_3050a3c7_emitMoonBitCoreToString(__expr __IRExpr, __receiver __IRExpr) string {
	return func() string {
		if __receiver.__text == "String" || __receiver.__kind == __ExprKind_String {
			return ____rune_private_3050a3c7_emitMoonBitExpr(__receiver)
		}
		return "(" + ____rune_private_3050a3c7_emitMoonBitExpr(__receiver) + ").to_string()"
	}()
}
...
func ____rune_private_68c6e3cf_emitTSExpr(__expr __IRExpr) string {
	return func() string {
		...
		case __expr.__kind == __ExprKind_String:
			return __expr.__value
		case __expr.__kind == __ExprKind_Template:
			return ____rune_private_68c6e3cf_emitTSTemplate(__expr)
		case __expr.__kind == __ExprKind_Char:
			return __expr.__value
		case __expr.__kind == __ExprKind_Regex:
			return __expr.__value
...
func ____rune_private_68c6e3cf_emitTSTemplate(__expr __IRExpr) string {
	__raw := __expr.__value
	__inner := func() string {
		if len([]rune(__raw)) >= 2 {
			return func() string { runes := []rune(__raw); return string(runes[1 : len([]rune(__raw))-1]) }()
	...
	return ____rune_private_68c6e3cf_emitTSTemplateParts(func() []string { parts := strings.Split(__inner, "<<<RUNE_TEMPLATE_PART>>>"); return parts }(), __expr.__children, 0, "`") + "`"
}

func ____rune_private_68c6e3cf_emitTSTemplateParts(__segments []string, __children []__IRExpr, __index int, __out string) string {
	return func() string {
		if __index >= len(__segments) {
			return __out
		}
		return ____rune_private_68c6e3cf_emitTSTemplateAtom(__segments, __children, __index, __out)
	}()
}

func ____rune_private_68c6e3cf_emitTSTemplateAtom(__segments []string, __children []__IRExpr, __index int, __out string) string {
	__textOut := __out + ____rune_private_68c6e3cf_tsEscapeTemplateText(__segments[__index])
	__next := func() string {
		if __index < len(__children) {
			return __textOut + ("${" + ____rune_private_68c6e3cf_emitTSExpr(__children[__index]) + "}")
		}
		return __textOut
	}()
	return ____rune_private_68c6e3cf_emitTSTemplateParts(__segments, __children, __index+1, __next)
}

func ____rune_private_68c6e3cf_tsEscapeTemplateText(__text string) string {
	return ____rune_private_68c6e3cf_tsEscapeTemplateChars(__text, 0, "")
}

func ____rune_private_68c6e3cf_tsEscapeTemplateChars(__text string, __index int, __out string) string {
	return func() string {
		if __index >= len([]rune(__text)) {
			return __out
		}
		return ____rune_private_68c6e3cf_tsEscapeTemplateChar(__text, __index, __out)
	}()
}

func ____rune_private_68c6e3cf_tsEscapeTemplateChar(__text string, __index int, __out string) string {
	return func() string {
		switch {
		case []rune(__text)[__index] == '$' && __index+1 < len([]rune(__text)) && []rune(__text)[__index+1] == '{' == true:
			return ____rune_private_68c6e3cf_tsEscapeTemplateChars(__text, __index+2, __out+"\\${")
		default:
			return ____rune_private_68c6e3cf_tsEscapeTemplateChars(__text, __index+1, __out+string(([]rune(__text)[__index])))
		}
	}()
}
...
func __generateDeclarations(__file __IRFile) string {
	__out := ____rune_private_aebb91df_dtsPreamble()
	__out = __out + ____rune_private_aebb91df_dtsStructs(__file.__structs, 0)
	__out = __out + ____rune_private_aebb91df_dtsEnums(__file.__enums, 0)
	__out = __out + ____rune_private_aebb91df_dtsConsts(__file.__constants, 0)
	__out = __out + ____rune_private_aebb91df_dtsFunctions(__file.__functions, 0)
	return __out + ____rune_private_aebb91df_dtsExports(__file)
}

func ____rune_private_aebb91df_dtsPreamble() string {
...
func ____rune_private_aebb91df_dtsStructs(__structs []__IRStructType, __index int) string {
	return func() string {
		if __index >= len(__structs) {
			return ""
		}
		return func() string {
			if __structs[__index].__private {
				return ____rune_private_aebb91df_dtsStructs(__structs, __index+1)
			}
			return ____rune_private_aebb91df_dtsStruct(__structs[__index]) + ____rune_private_aebb91df_dtsStructs(__structs, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsStruct(__typeDecl __IRStructType) string {
	__generics := ____rune_private_aebb91df_dtsGenerics(__typeDecl.__generics)
	__out := "type " + __mangleIdent(__typeDecl.__name) + __generics + " = {\n"
	__out = __out + ____rune_private_aebb91df_dtsStructFields(__typeDecl.__fields, 0)
	return __out + "};\n" + "\n"
}

func ____rune_private_aebb91df_dtsStructFields(__fields []__IRField, __index int) string {
	return func() string {
		if __index >= len(__fields) {
			return ""
		}
		return func() string {
			if __fields[__index].__private {
				return ____rune_private_aebb91df_dtsStructFields(__fields, __index+1)
			}
			return __indent(1) + ____rune_private_aebb91df_dtsPropertyName(__fields[__index].__name) + ": " + ____rune_private_aebb91df_dtsType(__fields[__index].__typeName) + ";\n" + ____rune_private_aebb91df_dtsStructFields(__fields, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsEnums(__enums []__IREnumType, __index int) string {
	return func() string {
		if __index >= len(__enums) {
			return ""
		}
		return func() string {
			if __enums[__index].__private {
				return ____rune_private_aebb91df_dtsEnums(__enums, __index+1)
			}
			return ____rune_private_aebb91df_dtsEnum(__enums[__index]) + ____rune_private_aebb91df_dtsEnums(__enums, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsEnum(__enumDecl __IREnumType) string {
	__name := __mangleIdent(__enumDecl.__name)
	__generics := ____rune_private_aebb91df_dtsGenerics(__enumDecl.__generics)
	__shape := func() string {
		switch {
		case ____rune_private_aebb91df_dtsEnumHasPayload(__enumDecl.__members, 0) == true:
			return "{ tag: number; payload: any[] }"
		case ____rune_private_aebb91df_dtsEnumHasPayload(__enumDecl.__members, 0) == false:
			return "number"
		}
		return ""
	}()
	...
	__out = __out + ____rune_private_aebb91df_dtsEnumMembers(__enumDecl.__members, 0)
	return __out + "};\n" + "\n"
}

func ____rune_private_aebb91df_dtsEnumHasPayload(__members []__IREnumMember, __index int) bool {
	return func() bool {
		if __index >= len(__members) {
			return false
		}
		return func() bool {
			...
			return ____rune_private_aebb91df_dtsEnumHasPayload(__members, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsEnumMembers(__members []__IREnumMember, __index int) string {
	return func() string {
		if __index >= len(__members) {
			return ""
		}
		return ____rune_private_aebb91df_dtsEnumMembersAt(__members, __index)
	}()
}

func ____rune_private_aebb91df_dtsEnumMembersAt(__members []__IREnumMember, __index int) string {
	return func() string {
		if __members[__index].__private {
			return ____rune_private_aebb91df_dtsEnumMembers(__members, __index+1)
		}
		return __indent(1) + "readonly " + ____rune_private_aebb91df_dtsPropertyName(__members[__index].__name) + ": " + __enumValue(__members[__index], __index) + ";\n" + ____rune_private_aebb91df_dtsEnumMembers(__members, __index+1)
	}()
}

func ____rune_private_aebb91df_dtsConsts(__constants []__IRConst, __index int) string {
	return func() string {
		if __index >= len(__constants) {
			return ""
		}
		return ____rune_private_aebb91df_dtsConstsAt(__constants, __index)
	}()
}

func ____rune_private_aebb91df_dtsConstsAt(__constants []__IRConst, __index int) string {
	return func() string {
		if __constants[__index].__private {
			return ____rune_private_aebb91df_dtsConsts(__constants, __index+1)
		}
		return "declare const " + __mangleIdent(__constants[__index].__name) + ": " + ____rune_private_aebb91df_dtsType(__constants[__index].__typeName) + ";\n" + ____rune_private_aebb91df_dtsConsts(__constants, __index+1)
	}()
}

func ____rune_private_aebb91df_dtsFunctions(__functions []__IRFunction, __index int) string {
	return func() string {
		if __index >= len(__functions) {
			return ""
		}
		return ____rune_private_aebb91df_dtsFunctionAt(__functions, __index) + ____rune_private_aebb91df_dtsFunctions(__functions, __index+1)
	}()
}

func ____rune_private_aebb91df_dtsFunctionAt(__functions []__IRFunction, __index int) string {
	return func() string {
		if __functions[__index].__macro || __functions[__index].__private {
			return ""
		}
		return ____rune_private_aebb91df_dtsFunction(__functions[__index])
	}()
}

func ____rune_private_aebb91df_dtsFunction(__fn __IRFunction) string {
	__returnType := ____rune_private_aebb91df_dtsType(__fn.__returnType)
	...
	return "declare function " + __mangleIdent(__fn.__name) + ____rune_private_aebb91df_dtsGenerics(__fn.__generics) + "(" + ____rune_private_aebb91df_dtsParams(__fn.__params, 0, "") + "): " + __wrapped + ";\n"
}

func ____rune_private_aebb91df_dtsGenerics(__generics []string) string {
	return func() string {
		if len(__generics) == 0 {
			return ""
		}
		return "<" + ____rune_private_aebb91df_dtsGenericNames(__generics, 0, "") + ">"
	}()
}

func ____rune_private_aebb91df_dtsGenericNames(__generics []string, __index int, __out string) string {
	return func() string {
		if __index >= len(__generics) {
			return __out
		}
		return ____rune_private_aebb91df_dtsGenericNames(__generics, __index+1, __out+func() string {
			if __index == 0 {
				return ""
			}
			return ", "
...
func ____rune_private_aebb91df_dtsParams(__params []__IRParam, __index int, __out string) string {
	return func() string {
		if __index >= len(__params) {
			return __out
		}
		return ____rune_private_aebb91df_dtsParams(__params, __index+1, __out+func() string {
			if __index == 0 {
				return ""
			}
			return ", "
		}()+__mangleIdent(__params[__index].__name)+": "+____rune_private_aebb91df_dtsType(__params[__index].__typeName))
	}()
}

func ____rune_private_aebb91df_dtsType(__typeName string) string {
	return ____rune_private_aebb91df_dtsTypeRef(____rune_private_aebb91df_parseDtsTypeRef(__typeName))
}

func ____rune_private_aebb91df_parseDtsTypeRef(__typeName string) __ParsedTypeRef {
	return ____rune_private_aebb91df_dtsTypeRefPostfix(__lex(__typeName), 0, ____rune_private_aebb91df_dtsTypeRoot(__typeName))
}

func ____rune_private_aebb91df_dtsTypeRoot(__typeName string) __ParsedTypeRef {
	__first := ____rune_private_aebb91df_dtsFirstTypeToken(__lex(__typeName), 0)
	return func() __ParsedTypeRef {
		switch {
		case __first.__kind == __TokenKind_BitAnd:
			return __namedParsedTypeRef(____rune_private_aebb91df_dtsTypeToken("Dynamic"))
		case __first.__kind == __TokenKind_At:
			return ____rune_private_aebb91df_dtsQualifiedTypeRef(__lex(__typeName), __first)
		case __first.__kind == __TokenKind_LParen:
			return ____rune_private_aebb91df_dtsParenTypeRef(__typeName, __first)
		case __first.__kind == __TokenKind_Ident:
			return __namedParsedTypeRef(__first)
		default:
			return __namedParsedTypeRef(____rune_private_aebb91df_dtsTypeToken(__typeName))
		}
	}()
}

func ____rune_private_aebb91df_dtsFirstTypeToken(__tokens []__Token, __index int) __Token {
	return func() __Token {
		if __index >= len(__tokens) {
			return ____rune_private_aebb91df_dtsTypeToken("Dynamic")
		}
		return func() __Token {
...
func ____rune_private_aebb91df_dtsQualifiedTypeRef(__tokens []__Token, __at __Token) __ParsedTypeRef {
	__module := ____rune_private_aebb91df_dtsTokenAt(__tokens, 1)
	__name := ____rune_private_aebb91df_dtsTokenAt(__tokens, 3)
	return func() __ParsedTypeRef {
...
func ____rune_private_aebb91df_dtsParenTypeRef(__typeName string, __open __Token) __ParsedTypeRef {
	...
	__parts := ____rune_private_aebb91df_dtsSplitTopLevelTypeArgs(__inner)
	return func() __ParsedTypeRef {
		if len(__parts) == 1 {
			return __groupedTypeRef(____rune_private_aebb91df_parseDtsTypeRef(__parts[0]), __open)
		}
		return __tupleTypeRef(____rune_private_aebb91df_dtsTupleParamsFromStrings(__parts, 0, append([]__ParsedTypeParam{}, []__ParsedTypeParam{__emptyParsedTypeParam()}[0:0]...)), __open)
	}()
}

func ____rune_private_aebb91df_dtsTypeToken(__typeName string) __Token {
	return __Token{__kind: __TokenKind_Ident, __lexeme: __typeName, __offset: 0, __line: 0, __column: 0}
}

func ____rune_private_aebb91df_dtsTypeRefPostfix(__tokens []__Token, __index int, __typeRef __ParsedTypeRef) __ParsedTypeRef {
	return func() __ParsedTypeRef {
		if __index >= len(__tokens) {
			return __typeRef
		}
		return ____rune_private_aebb91df_dtsTypeRefPostfixStep(__tokens, __index, __typeRef)
	}()
}

func ____rune_private_aebb91df_dtsTypeRefPostfixStep(__tokens []__Token, __index int, __typeRef __ParsedTypeRef) __ParsedTypeRef {
	__token := __tokens[__index]
	return func() __ParsedTypeRef {
		switch {
		case __token.__kind == __TokenKind_LBracket:
			return ____rune_private_aebb91df_dtsTypeRefPostfix(__tokens, ____rune_private_aebb91df_dtsSkipBracket(__tokens, __index+1, 1), ____rune_private_aebb91df_dtsApplyTypeArgs(__typeRef, ____rune_private_aebb91df_dtsBracketArgs(__tokens, __index)))
		case __token.__kind == __TokenKind_Question:
			return ____rune_private_aebb91df_dtsTypeRefPostfix(__tokens, __index+1, __nullableTypeRef(__typeRef))
		default:
			return ____rune_private_aebb91df_dtsTypeRefPostfix(__tokens, __index+1, __typeRef)
		}
	}()
}

func ____rune_private_aebb91df_dtsApplyTypeArgs(__typeRef __ParsedTypeRef, __args []__ParsedTypeRef) __ParsedTypeRef {
	return __typeRefWithArgs(__typeRef, __args)
}

func ____rune_private_aebb91df_dtsBracketArgs(__tokens []__Token, __open int) []__ParsedTypeRef {
	__close := ____rune_private_aebb91df_dtsBracketClose(__tokens, __open+1, 1)
	__inner := ____rune_private_aebb91df_dtsTokenRangeText(__tokens, __open+1, __close, "")
	__parts := ____rune_private_aebb91df_dtsSplitTopLevelTypeArgs(__inner)
	return ____rune_private_aebb91df_dtsTypeRefsFromStrings(__parts, 0, append([]__ParsedTypeRef{}, []__ParsedTypeRef{__emptyParsedTypeRef()}[0:0]...))
}

func ____rune_private_aebb91df_dtsBracketClose(__tokens []__Token, __index int, __depth int) int {
	return func() int {
		if __index >= len(__tokens) {
			return __index
		}
		return func() int {
			if __tokens[__index].__kind == __TokenKind_LBracket {
				return ____rune_private_aebb91df_dtsBracketClose(__tokens, __index+1, __depth+1)
			}
			return func() int {
				...
				return ____rune_private_aebb91df_dtsBracketClose(__tokens, __index+1, __depth)
			}()
		}()
	}()
}

func ____rune_private_aebb91df_dtsSkipBracket(__tokens []__Token, __index int, __depth int) int {
	return func() int {
		if __index >= len(__tokens) {
			return __index
		}
		return func() int {
			if __tokens[__index].__kind == __TokenKind_LBracket {
				return ____rune_private_aebb91df_dtsSkipBracket(__tokens, __index+1, __depth+1)
			}
			return func() int {
				if __tokens[__index].__kind == __TokenKind_RBracket {
					return func() int {
				...
				return ____rune_private_aebb91df_dtsSkipBracket(__tokens, __index+1, __depth)
			}()
		}()
	}()
}

func ____rune_private_aebb91df_dtsTokenAt(__tokens []__Token, __index int) __Token {
	return func() __Token {
		if __index >= len(__tokens) {
			return ____rune_private_aebb91df_dtsTypeToken("Dynamic")
		}
...
func ____rune_private_aebb91df_dtsTokenRangeText(__tokens []__Token, __index int, __endExclusive int, __out string) string {
	return func() string {
		if __index >= __endExclusive || __index >= len(__tokens) {
			return __out
		}
		return ____rune_private_aebb91df_dtsTokenRangeText(__tokens, __index+1, __endExclusive, __out+__tokens[__index].__lexeme)
	}()
}

func ____rune_private_aebb91df_dtsSplitTopLevelTypeArgs(__source string) []string {
	return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, 0, 0, 0, []string{})
}

func ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source string, __index int, __start int, __depth int, __out []string) []string {
	return func() []string {
		if __index >= len([]rune(__source)) {
			return ____rune_private_aebb91df_dtsPushTypeArg(__out, strings.TrimSpace((func() string { runes := []rune(__source); return string(runes[__start:len([]rune(__source))]) }())))
		}
		return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsStep(__source, __index, __start, __depth, __out)
	}()
}

func ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsStep(__source string, __index int, __start int, __depth int, __out []string) []string {
	__ch := []rune(__source)[__index]
	return func() []string {
		switch {
		case (__ch == '[') || (__ch == '('):
			return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, __index+1, __start, __depth+1, __out)
		case (__ch == ']') || (__ch == ')'):
			return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, __index+1, __start, __depth-1, __out)
		case __ch == ',':
			return func() []string {
				if __depth == 0 {
					return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, __index+1, __index+1, __depth, ____rune_private_aebb91df_dtsPushTypeArg(__out, strings.TrimSpace((func() string { runes := []rune(__source); return string(runes[__start:__index]) }()))))
				}
				return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, __index+1, __start, __depth, __out)
			}()
		default:
			return ____rune_private_aebb91df_dtsSplitTopLevelTypeArgsLoop(__source, __index+1, __start, __depth, __out)
		}
...
func ____rune_private_aebb91df_dtsPushTypeArg(__out []string, __item string) []string {
	if __item != "" {
...
func ____rune_private_aebb91df_dtsTypeRefsFromStrings(__parts []string, __index int, __out []__ParsedTypeRef) []__ParsedTypeRef {
	return func() []__ParsedTypeRef {
		if __index >= len(__parts) {
			return __out
		}
		return ____rune_private_aebb91df_dtsTypeRefsFromStringsPush(__parts, __index, __out)
	}()
}

func ____rune_private_aebb91df_dtsTypeRefsFromStringsPush(__parts []string, __index int, __out []__ParsedTypeRef) []__ParsedTypeRef {
	__out = append(__out, ____rune_private_aebb91df_parseDtsTypeRef(__parts[__index]))
	return ____rune_private_aebb91df_dtsTypeRefsFromStrings(__parts, __index+1, __out)
}

func ____rune_private_aebb91df_dtsTupleParamsFromStrings(__parts []string, __index int, __out []__ParsedTypeParam) []__ParsedTypeParam {
	return func() []__ParsedTypeParam {
		if __index >= len(__parts) {
			return __out
		}
		return ____rune_private_aebb91df_dtsTupleParamsFromStringsPush(__parts, __index, __out)
	}()
}

func ____rune_private_aebb91df_dtsTupleParamsFromStringsPush(__parts []string, __index int, __out []__ParsedTypeParam) []__ParsedTypeParam {
	__param := __emptyParsedTypeParam()
	__param.__name = ""
	__param.__optional = false
	__param.__typeRef = ____rune_private_aebb91df_parseDtsTypeRef(__parts[__index])
	__out = append(__out, __param)
	return ____rune_private_aebb91df_dtsTupleParamsFromStrings(__parts, __index+1, __out)
}

func ____rune_private_aebb91df_clearNullableTypeRef(__typeRef __ParsedTypeRef) __ParsedTypeRef {
...
func ____rune_private_aebb91df_dtsTypeRef(__typeRef __ParsedTypeRef) string {
	return func() string {
		switch {
		case __typeRef.__nullable == true:
			return ____rune_private_aebb91df_dtsNullableTypeRef(__typeRef)
		case __typeRef.__nullable == false:
			return ____rune_private_aebb91df_dtsPlainTypeRef(__typeRef)
		}
		return ""
	}()
}

func ____rune_private_aebb91df_dtsNullableTypeRef(__typeRef __ParsedTypeRef) string {
	return ____rune_private_aebb91df_dtsTypeRef(____rune_private_aebb91df_clearNullableTypeRef(__typeRef)) + " | null"
}

func ____rune_private_aebb91df_dtsPlainTypeRef(__typeRef __ParsedTypeRef) string {
	return func() string {
		switch {
		case __typeRef.__kind == __TypeRefKind_Name:
			return ____rune_private_aebb91df_dtsNamedTypeRef(__typeRef)
		case __typeRef.__kind == __TypeRefKind_Group:
			return ____rune_private_aebb91df_dtsGroupedTypeRef(__typeRef)
		case __typeRef.__kind == __TypeRefKind_Tuple:
			return ____rune_private_aebb91df_dtsTupleTypeRef(__typeRef)
		case __typeRef.__kind == __TypeRefKind_Function:
			return ____rune_private_aebb91df_dtsFunctionTypeRef(__typeRef)
		default:
			return "any"
		}
	}()
...
func ____rune_private_aebb91df_dtsNamedTypeRef(__typeRef __ParsedTypeRef) string {
	__typeName := ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef)
	return func() string {
		switch {
		case (__typeName == "") || (__typeName == "Void"):
			return "void"
		...
		case (__typeName == "Dynamic") || (__typeName == "Unknown"):
			return "any"
		default:
			return ____rune_private_aebb91df_dtsStructuredNamedTypeRef(__typeRef)
		}
	}()
}

func ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef __ParsedTypeRef) string {
	return func() string {
		if __typeRef.__module == "" {
...
func ____rune_private_aebb91df_dtsStructuredNamedTypeRef(__typeRef __ParsedTypeRef) string {
	return func() string {
		switch {
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Array":
			return ____rune_private_aebb91df_dtsArrayTypeRef(__typeRef)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Result":
			return ____rune_private_aebb91df_dtsGenericTypeRef("RuneResult", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Task":
			return ____rune_private_aebb91df_dtsGenericTypeRef("Promise", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Iter":
			return ____rune_private_aebb91df_dtsGenericTypeRef("RuneIter", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "ReadonlyArray":
			return ____rune_private_aebb91df_dtsGenericTypeRef("ReadonlyArray", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Tuple":
			return ____rune_private_aebb91df_dtsTupleArgs(__typeRef.__args, false)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "ReadonlyTuple":
			return ____rune_private_aebb91df_dtsTupleArgs(__typeRef.__args, true)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Map":
			return ____rune_private_aebb91df_dtsGenericTypeRef("Map", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Set":
			return ____rune_private_aebb91df_dtsGenericTypeRef("Set", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "WeakMap":
			return ____rune_private_aebb91df_dtsGenericTypeRef("WeakMap", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "WeakSet":
			return ____rune_private_aebb91df_dtsGenericTypeRef("WeakSet", __typeRef.__args)
		case ____rune_private_aebb91df_dtsQualifiedTypeName(__typeRef) == "Record":
			return ____rune_private_aebb91df_dtsGenericTypeRef("Record", __typeRef.__args)
		default:
			return ____rune_private_aebb91df_dtsNamedType(__typeRef)
		}
	}()
}

func ____rune_private_aebb91df_dtsArrayTypeRef(__typeRef __ParsedTypeRef) string {
	return func() string {
		if len(__typeRef.__args) == 0 {
			return "any[]"
		}
		return ____rune_private_aebb91df_dtsTypeRef(__typeRef.__args[0]) + "[]"
	}()
}

func ____rune_private_aebb91df_dtsGenericTypeRef(__name string, __args []__ParsedTypeRef) string {
	return __name + "<" + ____rune_private_aebb91df_dtsTypeRefs(__args, 0, "") + ">"
}

func ____rune_private_aebb91df_dtsNamedType(__typeRef __ParsedTypeRef) string {
	__prefix := func() string {
		if __typeRef.__module == "" {
			return ""
		}
	...
	return func() string {
		...
		return __mangleIdent(__prefix+__typeRef.__name) + "<" + ____rune_private_aebb91df_dtsTypeRefs(__typeRef.__args, 0, "") + ">"
	}()
}

func ____rune_private_aebb91df_dtsGroupedTypeRef(__typeRef __ParsedTypeRef) string {
	return func() string {
		if len(__typeRef.__args) == 0 {
			return "()"
		}
...
func ____rune_private_aebb91df_dtsTupleTypeRef(__typeRef __ParsedTypeRef) string {
	return ____rune_private_aebb91df_dtsTupleParams(__typeRef.__params, false)
}

func ____rune_private_aebb91df_dtsTupleParams(__params []__ParsedTypeParam, __readonly bool) string {
	__items := ____rune_private_aebb91df_dtsTypeParams(__params, 0, "")
	return func() string {
		if __readonly {
...
func ____rune_private_aebb91df_dtsTupleArgs(__args []__ParsedTypeRef, __readonly bool) string {
	__items := ____rune_private_aebb91df_dtsTypeRefs(__args, 0, "")
	return func() string {
		if __readonly {
			return "readonly [" + __items + "]"
		}
...
func ____rune_private_aebb91df_dtsFunctionTypeRef(__typeRef __ParsedTypeRef) string {
	__ret := func() string {
		if len(__typeRef.__returnTypes) == 0 {
			return "void"
		}
		return ____rune_private_aebb91df_dtsTypeRef(__typeRef.__returnTypes[0])
	}()
	return "(" + ____rune_private_aebb91df_dtsTypeParams(__typeRef.__params, 0, "") + ") => " + __ret
}

func ____rune_private_aebb91df_dtsTypeRefs(__refs []__ParsedTypeRef, __index int, __out string) string {
	return func() string {
		if __index >= len(__refs) {
			return __out
		}
		return ____rune_private_aebb91df_dtsTypeRefs(__refs, __index+1, __out+func() string {
			if __index == 0 {
				return ""
			}
			return ", "
		}()+____rune_private_aebb91df_dtsTypeRef(__refs[__index]))
	}()
}

func ____rune_private_aebb91df_dtsTypeParams(__params []__ParsedTypeParam, __index int, __out string) string {
	return func() string {
		if __index >= len(__params) {
			return __out
		}
		return ____rune_private_aebb91df_dtsTypeParams(__params, __index+1, __out+func() string {
			if __index == 0 {
				return ""
			}
			return ", "
		}()+____rune_private_aebb91df_dtsTypeParam(__params[__index]))
	}()
}

func ____rune_private_aebb91df_dtsTypeParam(__param __ParsedTypeParam) string {
	__prefix := func() string {
		if __param.__name == "" {
			return ""
		}
	...
	return __prefix + ____rune_private_aebb91df_dtsTypeRef(__param.__typeRef)
}

func ____rune_private_aebb91df_dtsExports(__file __IRFile) string {
	return func() string {
		if len(__file.__structs)+len(__file.__enums)+len(__file.__constants)+len(__file.__functions) == 0 {
			return ""
		}
		return "\n" + ____rune_private_aebb91df_dtsStructExports(__file.__structs, 0) + ____rune_private_aebb91df_dtsEnumExports(__file.__enums, 0) + ____rune_private_aebb91df_dtsConstExports(__file.__constants, 0) + ____rune_private_aebb91df_dtsFunctionExports(__file.__functions, 0)
	}()
}

func ____rune_private_aebb91df_dtsStructExports(__structs []__IRStructType, __index int) string {
	return func() string {
		if __index >= len(__structs) {
			return ""
		}
		return func() string {
			if __structs[__index].__private {
				return ____rune_private_aebb91df_dtsStructExports(__structs, __index+1)
			}
			return ____rune_private_aebb91df_dtsExportTypeAlias(__structs[__index].__name) + ____rune_private_aebb91df_dtsStructExports(__structs, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsEnumExports(__enums []__IREnumType, __index int) string {
	return func() string {
		if __index >= len(__enums) {
			return ""
		}
		return func() string {
			if __enums[__index].__private {
				return ____rune_private_aebb91df_dtsEnumExports(__enums, __index+1)
			}
			return ____rune_private_aebb91df_dtsExportTypeAlias(__enums[__index].__name) + ____rune_private_aebb91df_dtsExportValueAlias(__enums[__index].__name) + ____rune_private_aebb91df_dtsEnumExports(__enums, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsConstExports(__constants []__IRConst, __index int) string {
	return func() string {
		if __index >= len(__constants) {
			return ""
		}
		return func() string {
			if __constants[__index].__private {
				return ____rune_private_aebb91df_dtsConstExports(__constants, __index+1)
			}
			return ____rune_private_aebb91df_dtsExportValueAlias(__constants[__index].__name) + ____rune_private_aebb91df_dtsConstExports(__constants, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsFunctionExports(__functions []__IRFunction, __index int) string {
	return func() string {
		if __index >= len(__functions) {
			return ""
		}
		return func() string {
			if __functions[__index].__macro || __functions[__index].__private {
				return ____rune_private_aebb91df_dtsFunctionExports(__functions, __index+1)
			}
			return ____rune_private_aebb91df_dtsExportValueAlias(__functions[__index].__name) + ____rune_private_aebb91df_dtsFunctionExports(__functions, __index+1)
		}()
	}()
}

func ____rune_private_aebb91df_dtsExportTypeAlias(__name string) string {
	return func() string {
		if ____rune_private_aebb91df_dtsCanUseBareProperty(__name) {
			return "export type " + __name + " = " + __mangleIdent(__name) + ";\n"
		}
		return "export type { " + __mangleIdent(__name) + " as " + ____rune_private_aebb91df_dtsExportName(__name) + " };\n"
	}()
}

func ____rune_private_aebb91df_dtsExportValueAlias(__name string) string {
	return func() string {
		if ____rune_private_aebb91df_dtsCanUseBareProperty(__name) {
			return "export declare const " + __name + ": typeof " + __mangleIdent(__name) + ";\n"
		}
		return "export { " + __mangleIdent(__name) + " as " + ____rune_private_aebb91df_dtsExportName(__name) + " };\n"
	}()
}

func ____rune_private_aebb91df_dtsPropertyName(__name string) string {
	return func() string {
		if ____rune_private_aebb91df_dtsCanUseBareProperty(__name) {
			return __name
		}
		return ____rune_private_aebb91df_dtsQuoteName(__name)
	}()
}

func ____rune_private_aebb91df_dtsExportName(__name string) string {
	return ____rune_private_aebb91df_dtsPropertyName(__name)
}

func ____rune_private_aebb91df_dtsQuoteName(__name string) string {
	return "\"" + ____rune_private_aebb91df_dtsEscapeName(__name, 0, "") + "\""
}

func ____rune_private_aebb91df_dtsEscapeName(__name string, __index int, __out string) string {
	return func() string {
		if __index >= len([]rune(__name)) {
			return __out
		}
		return ____rune_private_aebb91df_dtsEscapeName(__name, __index+1, __out+____rune_private_aebb91df_dtsEscapeNameChar([]rune(__name)[__index]))
	}()
}

func ____rune_private_aebb91df_dtsEscapeNameChar(__ch rune) string {
	return func() string {
		switch {
		case __ch == '\\':
			return "\\\\"
...
func ____rune_private_aebb91df_dtsCanUseBareProperty(__name string) bool {
	return __name != "" && ____rune_private_aebb91df_dtsReservedName(__name) == false && ____rune_private_aebb91df_dtsSafeIdent(__name, 0, true)
}

func ____rune_private_aebb91df_dtsSafeIdent(__name string, __index int, __first bool) bool {
	return func() bool {
		if __index >= len([]rune(__name)) {
			return true
		}
		return func() bool {
			if ____rune_private_aebb91df_dtsSafeIdentChar([]rune(__name)[__index], __first) {
				return ____rune_private_aebb91df_dtsSafeIdent(__name, __index+1, false)
			}
			return false
		}()
	}()
...
func ____rune_private_aebb91df_dtsSafeIdentChar(__ch rune, __first bool) bool {
	return func() bool {
		switch {
...
func ____rune_private_aebb91df_dtsReservedName(__name string) bool {
	return func() bool {
		switch {
...
func __checkSourceWithPath(__source string, __sourcePath string) __CompileResult {
	return ____rune_private_0d2ebf0f_checkFile(____rune_private_0d2ebf0f_lowerCompilerSourceWithPath(__source, __sourcePath))
}
...
func __discoverSources(__root string) runeTask[runeResult[[]__SourceFile, *runeError]] {
	return runeGo(func() runeResult[[]__SourceFile, *runeError] {
		...
		return runeOk[[]__SourceFile, *runeError](____rune_private_0d2ebf0f_discoverSourceGraph([]__SourceFile{__SourceFile{__path: __root, __source: __source}}))
	})
}

func __hostBridgeSources(__root string, __files []__SourceFile) []__SourceFile {
	return ____rune_private_0d2ebf0f_discoverSourceGraph(__files)
}

func ____rune_private_0d2ebf0f_discoverSourceGraph(__files []__SourceFile) []__SourceFile {
	return ____rune_private_0d2ebf0f_discoverMergeSourceFiles(append([]__SourceFile{}, []__SourceFile{____rune_private_0d2ebf0f_emptySourceFile()}[0:0]...), __files, 0)
}
...
func ____rune_private_0d2ebf0f_discoverSourceImportPaths(__file __SourceFile) []string {
	__parsed := ____rune_private_0d2ebf0f_expandCompilerMacros(__parse(__file.__source))
	return ____rune_private_0d2ebf0f_appendDiscoverImportPaths([]string{}, __file.__path, __parsed.__imports, 0)
}

func ____rune_private_0d2ebf0f_appendDiscoverImportPaths(__pending []string, __basePath string, __imports []__ParsedImport, __index int) []string {
	return func() []string {
		if __index >= len(__imports) {
			return __pending
		}
		return ____rune_private_0d2ebf0f_appendDiscoverImportPath(__pending, __basePath, __imports, __index)
	}()
}

func ____rune_private_0d2ebf0f_appendDiscoverImportPath(__pending []string, __basePath string, __imports []__ParsedImport, __index int) []string {
	__importDecl := __imports[__index]
	__skip := __importDecl.__go || __importDecl.__module
	return func() []string {
		switch {
		case __skip == true:
			return ____rune_private_0d2ebf0f_appendDiscoverImportPaths(__pending, __basePath, __imports, __index+1)
		default:
			return ____rune_private_0d2ebf0f_appendDiscoverImportPaths(func() []string {
				out := []string{}
				out = append(out, __pending...)
				out = append(out, ____rune_private_0d2ebf0f_resolveCompilerImportPath(__basePath, __importDecl.__path))
				return out
...
func ____rune_private_0d2ebf0f_discoverMergeSourceFiles(__left []__SourceFile, __right []__SourceFile, __index int) []__SourceFile {
	return func() []__SourceFile {
		if __index >= len(__right) {
			return __left
		}
		return ____rune_private_0d2ebf0f_discoverMergeSourceFiles(func() []__SourceFile {
			if ____rune_private_0d2ebf0f_compilerContainsSourceFile(__left, __right[__index].__path, 0) {
				return __left
			}
			return func() []__SourceFile {
				out := []__SourceFile{}
...
func ____rune_private_0d2ebf0f_compilerContainsSourceFile(__files []__SourceFile, __path string, __index int) bool {
	return func() bool {
		if __index >= len(__files) {
			return false
		}
		return ____rune_private_0d2ebf0f_compilerPathNormalize(__files[__index].__path) == ____rune_private_0d2ebf0f_compilerPathNormalize(__path) || ____rune_private_0d2ebf0f_compilerContainsSourceFile(__files, __path, __index+1)
	}()
}
...
func ____rune_private_0d2ebf0f_checkFile(__file __IRFile) __CompileResult {
	return func() __CompileResult {
		if len(__file.__errors) > 0 {
			return ____rune_private_0d2ebf0f_compileResult(false, "", ____rune_private_0d2ebf0f_parseErrorMessages(__file.__errors))
		}
		return ____rune_private_0d2ebf0f_checkCheckedFile(__file)
	}()
}

func ____rune_private_0d2ebf0f_checkCheckedFile(__file __IRFile) __CompileResult {
	__errors := ____rune_private_0d2ebf0f_checkFileErrors(__file)
	return func() __CompileResult {
		if len(__errors) > 0 {
			return ____rune_private_0d2ebf0f_compileResult(false, "", __errors)
		}
		return ____rune_private_0d2ebf0f_compileResult(true, "", []string{})
	}()
}
...
func ____rune_private_0d2ebf0f_compileCheckedFile(__file __IRFile, __target string) __CompileResult {
	...
	return func() __CompileResult {
		...
		return func() __CompileResult {
			...
			case __target == "dts":
				return ____rune_private_0d2ebf0f_compileResult(true, __generateDeclarations(__file), []string{})
			default:
...
func ____rune_private_0d2ebf0f_checkExprDefault(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	__next := ____rune_private_0d2ebf0f_checkExprCall(__expr, __structs, __callables, __errors, __bindings)
...
func ____rune_private_0d2ebf0f_checkLetValueExpr(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	...
	return ____rune_private_0d2ebf0f_checkLetDeclaredType(__expr.__name, __value, __expr.__value, __structs, __callables, __bindings, __checked)
}
...
func ____rune_private_0d2ebf0f_checkExpectedSelectorExpr(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	return func() []string {
		switch {
		case __expr.__kind == __ExprKind_Selector:
			return ____rune_private_0d2ebf0f_checkSelectorExpr(__expr, __structs, __callables, __bindings, __errors)
		case __expr.__kind == __ExprKind_Block:
			return ____rune_private_0d2ebf0f_checkExpectedBlockSelectorExpr(__expr.__children, __structs, __callables, __bindings, __errors)
		default:
			return __errors
		}
	}()
...
func ____rune_private_0d2ebf0f_checkExpectedBlockSelectorExpr(__statements []__IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	...
	return func() []string {
		...
		case __empty == true:
			return __errors
		default:
			return ____rune_private_0d2ebf0f_checkExpectedSelectorExpr(__statements[len(__statements)-1], __structs, __callables, __bindings, __errors)
		}
	}()
}

func ____rune_private_0d2ebf0f_checkSelectorExpr(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	__hasReceiver := len(__expr.__children) > 0
	return func() []string {
		switch {
		case __hasReceiver == true:
			return ____rune_private_0d2ebf0f_checkSelectorReceiverExpr(__expr, __expr.__children[0], __structs, __callables, __bindings, __errors)
		default:
			return __errors
		}
	}()
...
func ____rune_private_0d2ebf0f_checkSelectorReceiverExpr(__expr __IRExpr, __receiver __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	return func() []string {
		switch {
...
func ____rune_private_0d2ebf0f_checkStructSelectorExpr(__expr __IRExpr, __receiverType string, __structs []__IRStructType, __bindings []__CompilerTypeBinding, __errors []string) []string {
	return func() []string {
		...
		default:
			return func() []string {
				__typeDecl := ____rune_private_0d2ebf0f_findCompilerStruct(__structs, ____rune_private_0d2ebf0f_compilerTypeBase(__receiverType), 0)
				__found := __typeDecl.__name != ""
				return func() []string {
					switch {
					case __found == true:
...
func ____rune_private_0d2ebf0f_checkLetDeclaredType(__name string, __value __IRExpr, __expected string, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	__actual := ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__value, __structs, __callables, __bindings)
	__mismatch := ____rune_private_0d2ebf0f_compilerShouldCheckArgType(__expected, __actual) && ____rune_private_0d2ebf0f_compilerTypesCompatible(__expected, __actual) == false
	return func() []string {
		switch {
...
func ____rune_private_0d2ebf0f_checkBlockExprStep(__statements []__IRExpr, __index int, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	...
	__nextBindings := ____rune_private_0d2ebf0f_blockBindingsAfterStatement(__statement, __structs, __callables, __bindings)
...
func ____rune_private_0d2ebf0f_blockBindingsAfterStatement(__statement __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) []__CompilerTypeBinding {
	return func() []__CompilerTypeBinding {
		switch {
...
func ____rune_private_0d2ebf0f_bindCompilerLet(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) []__CompilerTypeBinding {
	__hasValue := len(__expr.__children) > 0
	return func() []__CompilerTypeBinding {
		switch {
		case __hasValue == true:
...
func ____rune_private_0d2ebf0f_compilerLetBindingType(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	return func() string {
		switch {
		case __expr.__value == "":
			return ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__expr.__children[0], __structs, __callables, __bindings)
		default:
			return __expr.__value
		}
	}()
...
func ____rune_private_0d2ebf0f_checkExprCall(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	...
	return func() []string {
		...
		case __identifierCall == true:
			return ____rune_private_0d2ebf0f_checkIdentifierCall(__expr, __expr.__children[0].__name, len(__expr.__children)-1, __structs, __callables, __errors, __bindings)
		default:
			return ____rune_private_0d2ebf0f_checkSelectorCall(__expr, __structs, __callables, __errors, __bindings)
		}
	}()
}

func ____rune_private_0d2ebf0f_checkSelectorCall(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	...
	return func() []string {
		...
		case __selectorCall == true:
			return ____rune_private_0d2ebf0f_checkSelectorCallExpr(__expr, __expr.__children[0], __structs, __callables, __errors, __bindings)
		default:
			return __errors
		}
	}()
...
func ____rune_private_0d2ebf0f_checkSelectorCallExpr(__expr __IRExpr, __selector __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	__hasReceiver := len(__selector.__children) > 0
	return func() []string {
		switch {
		case __hasReceiver == true:
			return ____rune_private_0d2ebf0f_checkSelectorCallReceiver(__expr, __selector, __selector.__children[0], __structs, __callables, __errors, __bindings)
		default:
			return __errors
		}
	}()
...
func ____rune_private_0d2ebf0f_checkSelectorCallReceiver(__expr __IRExpr, __selector __IRExpr, __receiver __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	return func() []string {
		switch {
		case __receiver.__kind == __ExprKind_At:
			return ____rune_private_0d2ebf0f_checkAtSelectorCall(__expr, __selector, __receiver, __structs, __callables, __errors, __bindings)
		case __receiver.__kind == __ExprKind_Identifier:
			return ____rune_private_0d2ebf0f_checkIdentifierSelectorCall(__expr, __selector, __receiver, __structs, __callables, __errors, __bindings)
		default:
			return ____rune_private_0d2ebf0f_checkInstanceSelectorCall(__expr, __selector, __receiver, __structs, __callables, __errors, __bindings)
		}
	}()
}
...
func ____rune_private_0d2ebf0f_checkGoExprCall(__expr __IRExpr, __errors []string) []string {
	return func() []string {
		__match5 := ____rune_private_0d2ebf0f_compilerCallArgCount(__expr)
		switch {
		case __match5 == 1:
...
func ____rune_private_0d2ebf0f_checkGoStmtCall(__expr __IRExpr, __errors []string) []string {
	return func() []string {
		__match6 := ____rune_private_0d2ebf0f_compilerCallArgCount(__expr)
		switch {
		case __match6 == 1:
...
func ____rune_private_0d2ebf0f_checkIdentifierSelectorCall(__expr __IRExpr, __selector __IRExpr, __receiver __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	return func() []string {
		...
		case __selector.__op == "::":
			return ____rune_private_0d2ebf0f_checkStaticSelectorCall(__expr, __selector, __receiver.__name, __structs, __callables, __errors, __bindings)
		default:
			return ____rune_private_0d2ebf0f_checkInstanceSelectorCall(__expr, __selector, __receiver, __structs, __callables, __errors, __bindings)
		}
	}()
...
func ____rune_private_0d2ebf0f_checkStaticSelectorCall(__expr __IRExpr, __selector __IRExpr, __receiverType string, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
...
func ____rune_private_0d2ebf0f_checkInstanceSelectorCall(__expr __IRExpr, __selector __IRExpr, __receiver __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	__receiverType := ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__receiver, __structs, __callables, __bindings)
	__known := __receiverType != ""
	return func() []string {
		switch {
		case __known == true:
			return ____rune_private_0d2ebf0f_checkKnownInstanceSelectorCall(__expr, __selector, ____rune_private_0d2ebf0f_compilerTypeBase(__receiverType), __structs, __callables, __errors, __bindings)
		default:
			return __errors
		}
	}()
...
func ____rune_private_0d2ebf0f_checkKnownInstanceSelectorCall(__expr __IRExpr, __selector __IRExpr, __receiverType string, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
...
func ____rune_private_0d2ebf0f_checkIdentifierCall(__expr __IRExpr, __name string, __arity int, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	__callable := ____rune_private_0d2ebf0f_findCompilerCallable(__callables, __name, 0)
	__found := __callable.__name != ""
	return func() []string {
		switch {
...
func ____rune_private_0d2ebf0f_checkCallableCall(__callable __CompilerCallable, __expr __IRExpr, __arity int, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string) []string {
	...
	return func() []string {
		switch {
		case __arityOk == true:
			return ____rune_private_0d2ebf0f_checkCallableArgTypes(__callable, __expr, __structs, __callables, __bindings, __errors, 0)
		default:
...
func ____rune_private_0d2ebf0f_checkCallableArgTypes(__callable __CompilerCallable, __expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string, __index int) []string {
	...
	return func() []string {
		...
		case __done == true:
			return __errors
		default:
			return ____rune_private_0d2ebf0f_checkCallableArgType(__callable, __expr, __structs, __callables, __bindings, __errors, __index)
		}
	}()
}

func ____rune_private_0d2ebf0f_checkCallableArgType(__callable __CompilerCallable, __expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __errors []string, __index int) []string {
	__expected := __callable.__paramTypes[__index]
	__arg := __expr.__children[__index+1]
	__checked := ____rune_private_0d2ebf0f_checkExpectedExprType(__arg, __expected, __structs, __callables, __bindings, __errors)
	__actual := ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__arg, __structs, __callables, __bindings)
	__mismatch := ____rune_private_0d2ebf0f_compilerShouldCheckArgType(__expected, __actual) && ____rune_private_0d2ebf0f_compilerTypesCompatible(__expected, __actual) == false
	__next := func() []string {
		switch {
		case __mismatch == true:
	...
	return ____rune_private_0d2ebf0f_checkCallableArgTypes(__callable, __expr, __structs, __callables, __bindings, __next, __index+1)
}
...
func ____rune_private_0d2ebf0f_checkFunctionReturn(__fn __IRFunction, __structs []__IRStructType, __callables []__CompilerCallable, __errors []string, __bindings []__CompilerTypeBinding) []string {
	...
	__actual := ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__fn.__body, __structs, __callables, __bindings)
	__shouldCheck := __expected != "" && __expected != "Dynamic" && __actual != ""
	return func() []string {
		switch {
		case __shouldCheck == true:
...
func ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	return func() string {
		switch {
		case __expr.__kind == __ExprKind_Selector:
...
func ____rune_private_0d2ebf0f_inferCompilerSelectorTypeWithStructs(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	__hasReceiver := len(__expr.__children) > 0
	return func() string {
		switch {
		case __hasReceiver == true:
			return ____rune_private_0d2ebf0f_inferCompilerSelectorTypeFromReceiverWithStructs(__expr, __expr.__children[0], __structs, __callables, __bindings)
		default:
			return ""
		}
	}()
...
func ____rune_private_0d2ebf0f_inferCompilerSelectorTypeFromReceiverWithStructs(__expr __IRExpr, __receiver __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	return func() string {
		switch {
		case __receiver.__kind == __ExprKind_At:
			return ____rune_private_0d2ebf0f_inferCompilerSelectorTypeFromReceiver(__expr, __receiver, __callables, __bindings)
		default:
			return ____rune_private_0d2ebf0f_inferCompilerStructSelectorType(__expr, ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__receiver, __structs, __callables, __bindings), __structs)
		}
	}()
}

func ____rune_private_0d2ebf0f_inferCompilerStructSelectorType(__expr __IRExpr, __receiverType string, __structs []__IRStructType) string {
	return func() string {
		switch {
		case __receiverType == "":
			return ""
...
func ____rune_private_0d2ebf0f_inferCompilerBlockType(__expr __IRExpr, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	return ____rune_private_0d2ebf0f_inferCompilerBlockTypeWithStructs(__expr, append([]__IRStructType{}, []__IRStructType{____rune_private_0d2ebf0f_emptyCompilerStruct()}[0:0]...), __callables, __bindings)
}

func ____rune_private_0d2ebf0f_inferCompilerBlockTypeWithStructs(__expr __IRExpr, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	return ____rune_private_0d2ebf0f_inferCompilerBlockTypeAtWithStructs(__expr.__children, 0, __structs, __callables, __bindings, "Void")
}

func ____rune_private_0d2ebf0f_inferCompilerBlockTypeAtWithStructs(__statements []__IRExpr, __index int, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding, __lastType string) string {
	__done := __index >= len(__statements)
	return func() string {
		switch {
		case __done == true:
			return __lastType
		default:
			return ____rune_private_0d2ebf0f_inferCompilerBlockTypeStepWithStructs(__statements, __index, __structs, __callables, __bindings)
		}
	}()
}

func ____rune_private_0d2ebf0f_inferCompilerBlockTypeStepWithStructs(__statements []__IRExpr, __index int, __structs []__IRStructType, __callables []__CompilerCallable, __bindings []__CompilerTypeBinding) string {
	__statement := __statements[__index]
	__statementType := ____rune_private_0d2ebf0f_inferCompilerExprTypeWithStructs(__statement, __structs, __callables, __bindings)
	__nextBindings := ____rune_private_0d2ebf0f_blockBindingsAfterStatement(__statement, __structs, __callables, __bindings)
	return ____rune_private_0d2ebf0f_inferCompilerBlockTypeAtWithStructs(__statements, __index+1, __structs, __callables, __nextBindings, __statementType)
}
...
func ____rune_private_0d2ebf0f_compilerMacroPurityError(__fn __ParsedFunction, __errors []__ParseError) []__ParseError {
	return func() []__ParseError {
		__match7 := ____rune_private_0d2ebf0f_compilerParsedMacroPurityMessage(__fn.__body)
		switch {
		case __match7 == "":
			return __errors
		case true:
